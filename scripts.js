...
(() => {
      ...
      e.exports = function() {
        ...
        o.prototype = {
          diff: function(e, t) {
            ...
            var s = (t = this.removeEmpty(this.tokenize(t))).length, c = e.length, l = 1, p = s + c,
              d = [{ newPos: -1, components: [] }], f = this.extractCommon(d[0], t, e, 0);
        ...
        var c = /^[A-Za-z\xC0-\u02C6\u02C8-\u02D7\u02DE-\u02FF\u1E00-\u1EFF]+$/, l = /\S/, p = new o;
        p.equals = function(e, t) {
          ...
          for (var t = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), n = 0; n < t.length - 1; n++) !t[n + 1] && t[n + 2] && c.test(t[n]) && c.test(t[n + 2]) && (t[n] += t[n + 2], t.splice(n + 1, 2), n--);
          return t;
        };
        var d = new o;
        ...
        var E = Object.prototype.toString, C = new o;

        function b(e, t, n, r, o) {
          var u, i;
          for (t = t || [], n = n || [], r && (e = r(o, e)), u = 0; u < t.length; u += 1) if (t[u] === e) return n[u];
          if ('[object Array]' === E.call(e)) {
            for (t.push(e), i = new Array(e.length), n.push(i), u = 0; u < e.length; u += 1) i[u] = b(e[u], t, n, r, o);
        ...
        C.useLongestToken = !0, C.tokenize = d.tokenize, C.castInput = function(e) {
          ...
          return o.prototype.equals.call(C, e.replace(/,([\r\n])/g, '$1'), t.replace(/,([\r\n])/g, '$1'));
        };
        var v = new o;
        ...
        function x(e, t) {
          ...
          for (var h = 0; h < a.length; h++) {
            for (var m = a[h], g = u.length - m.oldLines, D = 0, y = d + m.oldStart - 1, E = F(y, p, g); void 0 !== D; D = E()) if (f(m, y + D)) {
              m.offset = d += D;
              break;
            }
          ...
          for (var C = 0, b = 0; b < a.length; b++) {
            var v = a[b], x = v.oldStart + v.offset + C - 1;
            C += v.newLines - v.oldLines;
            for (var S = 0; S < v.lines.length; S++) {
              var w = v.lines[S], T = w.length > 0 ? w[0] : ' ', B = w.length > 0 ? w.substr(1) : w,
                k = v.linedelimiters[S];
              if (' ' === T) x++; else if ('-' === T) u.splice(x, 1), i.splice(x, 1); else if ('+' === T) u.splice(x, 0, B), i.splice(x, 0, k), x++; else if ('\\' === T) {
                var N = v.lines[S - 1] ? v.lines[S - 1][0] : null;
                '+' === N ? r = !0 : '-' === N && (o = !0);
              }
            }
          }
        ...
        function S(e, t, n, r, o, u, i) {
          ...
          for (var c = [], l = 0, p = 0, d = [], h = 1, m = 1, g = function(e) {
            ...
            if (t.lines = o, t.added || t.removed) {
              ...
              (u = d).push.apply(u, D(o.map((function(e) {
                return (t.added ? '+' : '-') + e;
              ...
              if (l) if (o.length <= 2 * i.context && e < a.length - 2) {
                ...
                if (e >= a.length - 2 && o.length <= i.context) {
                  var b = /\n$/.test(n), v = /\n$/.test(r), A = 0 == o.length && d.length > C.oldLines;
        ...
        function B(e) {
          var t = U(e.lines), n = t.oldLines, r = t.newLines;
        ...
        function L(e, t, n, r, o) {
          var u = { offset: t, lines: n, index: 0 }, i = { offset: r, lines: o, index: 0 };
          for (R(e, u, i), R(e, i, u); u.index < u.lines.length && i.index < i.lines.length;) {
            ...
            } else '-' === a[0] && ' ' === s[0] ? M(e, u, i) : '-' === s[0] && ' ' === a[0] ? M(e, i, u, !0) : a === s ? (e.lines.push(a), u.index++, i.index++) : j(e, V(u), V(i)); else I(e, u, i);
          }
          q(e, u), q(e, i), B(e);
        }
        ...
        function I(e, t, n) {
          ...
          if ($(r) && $(o)) {
            var u, i;
            if (T(r, o) && W(n, r, r.length - o.length)) return void (u = e.lines).push.apply(u, D(r));
            if (T(o, r) && W(t, o, o.length - r.length)) return void (i = e.lines).push.apply(i, D(o));
          } else if (function(e, t) {
            return e.length === t.length && T(e, t);
          }(r, o)) {
            var a;
            return void (a = e.lines).push.apply(a, D(r));
          }
          j(e, r, o);
        }
        ...
        v.tokenize = function(e) {
          return e.slice();
        }, v.join = v.removeEmpty = function(e) {
          return e;
        };
        var z = Object.freeze({
          __proto__: null, Diff: o, applyPatch: x, applyPatches: function(e, t) {
          ...
          }, canonicalize: b, convertChangesToDMP: function(e) {
            ...
            return w(e, e, t, n, r, o, u);
          }, createTwoFilesPatch: w, diffArrays: function(e, t, n) {
            return v.diff(e, t, n);
            ...
            return C.diff(e, t, n);
          }, diffLines: f, diffSentences: function(e, t, n) {
            return h.diff(e, t, n);
          }, diffTrimmedLines: function(e, t, n) {
            var r = s(n, { ignoreWhitespace: !0 });
            return d.diff(e, t, r);
          }, diffWords: function(e, t, n) {
            return n = s(n, { ignoreWhitespace: !0 }), p.diff(e, t, n);
            ...
            for (var o = 0, u = 0, i = 0, a = 0; o < e.hunks.length || u < t.hunks.length;) {
              var s = e.hunks[o] || { oldStart: 1 / 0 }, c = t.hunks[u] || { oldStart: 1 / 0 };
              if (O(s, c)) r.hunks.push(_(s, i)), o++, a += s.newLines - s.oldLines; else if (O(c, s)) r.hunks.push(_(c, a)), u++, i += c.newLines - c.oldLines; else {
                var l = {
            ...
            return r;
          }, parsePatch: A, structuredPatch: S
        });
        ...
        const K = { type: 'break-parent' }, Q = H([{ type: 'line', hard: !0 }, K]),
        ...
        var ee = {
          ...
          conditionalGroup: function(e, t) {
            return Y(e[0], Object.assign({}, t, { expandedStates: e }));
          },
          fill: function(e) {
        ...
        const oe = e => {
          ...
          e = (e => 'string' == typeof e ? e.replace((({ onlyFirst: e = !1 } = {}) => {
        ...
        var Ae = ve, Fe = ve, xe = ve, Se = ve, we = ve, Te = ve, Be = ve, ke = ce.performance || {},
          Ne = ke.now || ke.mozNow || ke.msNow || ke.oNow || ke.webkitNow || function() {
            ...
            hrtime: function(e) {
              var t = .001 * Ne.call(ke), n = Math.floor(t), r = Math.floor(t % 1 * 1e9);
        ...
        var Xe = Ge, Ye = (e, t, n) => new Xe(e, n).compare(new Xe(t, n)), Ke = Me((function(e, t) {
          function n() {
          ...
          function d(e, t, n) {
            ...
            var u = new RegExp('(\\r\\n|\\r|\\n).{0,' + r + '}', 'g');
            t && (e = e.slice(1));
            var i = n.newline, c = n.trimLeadingNewline, p = n.trimTrailingNewline, d = 'string' == typeof i,
              f = e.length;
        ...
        const { outdent: ot } = Ke, ut = 'Config', it = 'Editor', at = 'Other', st = 'Global', ct = 'Special', lt = {
          cursorOffset: {
            since: '1.4.0',
            category: ct,
            type: 'int',
        ...
        }, pt = Ye, dt = (e, t, n) => Ye(e, t, n) < 0, ft = (e, t, n) => Ye(e, t, n) >= 0, ht = r.version, mt = lt;
        var gt = {
          getSupportInfo: function({
            ...
            const u = ht.split('-', 1)[0], i = t.reduce(((e, t) => e.concat(t.languages || [])), []).filter(s),
              a = ((e, t) => Object.entries(e).map((([e, t]) => Object.assign({ name: e }, t))))(Object.assign({}, ...t.map((({ options: e }) => e)), mt)).filter((e => s(e) && c(e))).sort(((e, t) => e.name === t.name ? 0 : e.name < t.name ? -1 : 1)).map((function(t) {
                return o ? t : e(t, ['cliName', 'cliCategory', 'cliDescription']);
              })).map((e => {
            ...
            function s(e) {
              return n || !('since' in e) || e.since && ft(u, e.since);
            }

            function c(e) {
              return r || !('deprecated' in e) || e.deprecated && dt(u, e.deprecated);
            }
          }
        };
        ...
        function Pt(e, t) {
          const n = e.slice(1, -1), r = { quote: '"', regex: /"/g }, o = { quote: '\'', regex: /'/g },
            u = '\'' === t ? o : r, i = u === o ? r : o;
          let a = u.quote;
        ...
        var Lt = {
          ...
          printString: function(e, t, n) {
            const r = e.slice(1, -1), o = !r.includes('"') && !r.includes('\''),
          ...
          addLeadingComment: function(e, t) {
            t.leading = !0, t.trailing = !1, _t(e, t);
          },
          addDanglingComment: function(e, t, n) {
            t.leading = !1, t.trailing = !1, n && (t.marker = n), _t(e, t);
          },
          addTrailingComment: function(e, t) {
            t.leading = !1, t.trailing = !0, _t(e, t);
          },
        ...
        const { getStringWidth: Mt } = Lt, { convertEndOfLineToChars: jt } = It, {
          concat: Rt,
          fill: qt,
          cursor: Vt
        } = ee;
        ...
        function Ut(e, t, n) {
          return t === -1 / 0 ? e.root || {
            ...
            length: 0,
            queue: []
          } : t < 0 ? Jt(e, { type: 'dedent' }, n) : t ? 'root' === t.type ? Object.assign({}, e, { root: e }) : Jt(e, {
        ...
        function Ht(e, t, n, r, o) {
          ...
          for (; n >= 0;) {
            ...
            const [e, s, c] = i.pop();
            if ('string' == typeof c) a.push(c), n -= Mt(c); else switch (c.type) {
              case'concat':
              ...
              case'fill':
                ...
                break;
              case'if-break': {
                const t = c.groupId ? $t[c.groupId] : s;
        ...
        var Gt = {
          printDocToString: function(e, t) {
            $t = {};
            const n = t.printWidth, r = jt(t.endOfLine);
            let o = 0;
            const u = [[{ value: '', length: 0, queue: [] }, 1, e]], i = [];
            let a = !1, s = [];
            for (; 0 !== u.length;) {
              const [e, c, l] = u.pop();
              if ('string' == typeof l) {
            ...
            if (-1 !== c) {
              const e = i.indexOf(Vt.placeholder, c + 1), t = i.slice(0, c).join(''), n = i.slice(c + 1, e).join('');
        ...
        function an(e) {
          ...
          }) : e.contents ? Object.assign({}, e, { contents: an(e.contents) }) : e;
        }
        ...
        var cn = {
          builders: ee, printer: Gt, utils: {
            isEmpty: function(e) {
              ...
              return en(e, tn, !1);
            }, traverseDoc: Qt, findInDoc: en, mapDoc: Zt, propagateBreaks: function(e) {
              const t = new Set, n = [];
              Qt(e, (function(e) {
              ...
              return t;
            }, normalizeParts: un, normalizeDoc: function(e) {
        ...
        gn.posix = gn;
        var Dn = gn, yn = Object.freeze(Object.assign(Object.create(null), Dn, { default: Dn, __moduleExports: Dn })),
        ...
        function Sn(e, t, n, r, o) {
          var u, i, a = 8 * o - r - 1, s = (1 << a) - 1, c = s >> 1, l = -7, p = n ? o - 1 : 0, d = n ? -1 : 1,
            f = e[t + p];
        ...
        function wn(e, t, n, r, o, u) {
          var i, a, s, c = 8 * u - o - 1, l = (1 << c) - 1, p = l >> 1,
            d = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f = r ? 0 : u - 1, h = r ? 1 : -1,
            m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        ...
        function Nn(e, t) {
          if (kn() < t) throw new RangeError('Invalid typed array length');
        ...
        function On(e, t, n, r) {
          ...
          return 'undefined' != typeof ArrayBuffer && t instanceof ArrayBuffer ? function(e, t, n, r) {
            ...
            return t = void 0 === n && void 0 === r ? new Uint8Array(t) : void 0 === r ? new Uint8Array(t, n) : new Uint8Array(t, n, r), Pn.TYPED_ARRAY_SUPPORT ? (e = t).__proto__ = Pn.prototype : e = In(e, t), e;
          }(e, t, n, r) : 'string' == typeof t ? function(e, t, n) {
            if ('string' == typeof n && '' !== n || (n = 'utf8'), !Pn.isEncoding(n)) throw new TypeError('"encoding" must be a valid string encoding');
            var r = 0 | Rn(t, n), o = (e = Nn(e, r)).write(t, n);
            return o !== r && (e = e.slice(0, o)), e;
          }(e, t, n) : function(e, t) {
            if (jn(t)) {
              var n = 0 | Mn(t.length);
              return 0 === (e = Nn(e, n)).length || t.copy(e, 0, 0, n), e;
            }
            if (t) {
              if ('undefined' != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || 'length' in t) return 'number' != typeof t.length || (r = t.length) != r ? Nn(e, 0) : In(e, t);
              if ('Buffer' === t.type && Bn(t.data)) return In(e, t.data);
            }
            var r;
        ...
        function Ln(e, t) {
          if (_n(t), e = Nn(e, t < 0 ? 0 : 0 | Mn(t)), !Pn.TYPED_ARRAY_SUPPORT) for (var n = 0; n < t; ++n) e[n] = 0;
          return e;
        }
        ...
        function Mn(e) {
          if (e >= kn()) throw new RangeError('Attempt to allocate Buffer larger than maximum size: 0x' + kn().toString(16) + ' bytes');
          return 0 | e;
        }
        ...
        function Kn(e, t, n) {
          ...
          return function(e) {
            ...
            for (var n = '', r = 0; r < t;) n += String.fromCharCode.apply(String, e.slice(r, r += Qn));
            return n;
          }(r);
        }
        ...
        Pn.TYPED_ARRAY_SUPPORT = void 0 === ce.TYPED_ARRAY_SUPPORT || ce.TYPED_ARRAY_SUPPORT, Pn.poolSize = 8192, Pn._augment = function(e) {
          ...
          return function(e, t, n, r) {
            return _n(t), t <= 0 ? Nn(e, t) : void 0 !== n ? 'string' == typeof r ? Nn(e, t).fill(n, r) : Nn(e, t).fill(n) : Nn(e, t);
          }(null, e, t, n);
          ...
          var e = 0 | this.length;
          return 0 === e ? '' : 0 === arguments.length ? Kn(this, 0, e) : qn.apply(this, arguments);
        ...
        Pn.prototype.slice = function(e, t) {
          ...
          if (t >>>= 0, n = void 0 === n ? this.length : n >>> 0, e || (e = 0), 'number' == typeof e) for (u = t; u < n; ++u) this[u] = e; else {
            var i = jn(e) ? e : dr(new Pn(e, r).toString()), a = i.length;
        ...
        var Cr = { ConfigError: Dr, DebugError: yr, UndefinedParserError: Er }, br = function(e, t) {
        ...
        var Sr = Object.freeze({
          __proto__: null, __extends: function(e, t) {
          ...
          }, __values: Ar, __read: Fr, __spread: function() {
            for (var e = [], t = 0; t < arguments.length; t++) e = e.concat(Fr(arguments[t]));
            return e;
            ...
            return r;
          }, __await: xr, __asyncGenerator: function(e, t, n) {
            ...
            function r(r, o) {
              t[r] = e[r] ? function(t) {
                return (n = !n) ? { value: xr(e[r](t)), done: 'return' === r } : o ? o(t) : t;
              } : o;
            }
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(wr, t);
        })), Br = /[|\\{}()[\]^$+*?.]/g, kr = function(e) {
          if ('string' != typeof e) throw new TypeError('Expected a string');
          return e.replace(Br, '\\$&');
        }, Nr = {
          ...
          r.rgb.hsl = function(e) {
            var t, n, r = e[0] / 255, o = e[1] / 255, u = e[2] / 255, i = Math.min(r, o, u), a = Math.max(r, o, u),
              s = a - i;
            ...
            var t, n, r, o, u, i = e[0] / 255, a = e[1] / 255, s = e[2] / 255, c = Math.max(i, a, s),
              l = c - Math.min(i, a, s), p = function(e) {
                return (c - e) / 6 / l + .5;
              };
            ...
            if (n) return n;
            var r, o, u, i = 1 / 0;
            for (var a in Nr) if (Nr.hasOwnProperty(a)) {
            ...
            var t = e[0] / 60, n = e[1] / 100, r = e[2] / 100, o = Math.floor(t) % 6, u = t - Math.floor(t),
              i = 255 * r * (1 - n), a = 255 * r * (1 - n * u), s = 255 * r * (1 - n * (1 - u));
            switch (r *= 255, o) {
              case 0:
                return [r, s, i];
              case 1:
            ...
            var t, n = e[0] / 255, r = e[1] / 255, o = e[2] / 255, u = Math.max(Math.max(n, r), o),
              i = Math.min(Math.min(n, r), o), a = u - i;
            return t = a <= 0 ? 0 : u === n ? (r - o) / a % 6 : u === r ? 2 + (o - n) / a : 4 + (n - r) / a + 4, t /= 6, [360 * (t %= 1), 100 * a, 100 * (a < 1 ? i / (1 - a) : 0)];
          }, r.hsl.hcg = function(e) {
            var t, n = e[1] / 100, r = e[2] / 100, o = 0;
        ...
        function _r(e, t) {
          for (var n = [t[e].parent, e], r = Pr[t[e].parent][e], o = t[e].parent; t[o].parent;) n.unshift(t[o].parent), r = Or(Pr[t[o].parent][o], r), o = t[o].parent;
        ...
        Object.keys(Pr).forEach((function(e) {
          ...
          var t = function(e) {
            for (var t = function(e) {
              var t = function() {
                for (var e = {}, t = Object.keys(Pr), n = t.length, r = 0; r < n; r++) e[t[r]] = {
                  distance: -1,
                  parent: null
                };
                return e;
              }(), n = [e];
              for (t[e].distance = 0; n.length;) for (var r = n.pop(), o = Object.keys(Pr[r]), u = o.length, i = 0; i < u; i++) {
                var a = o[i], s = t[a];
        ...
        var Ir = Lr, Mr = Me((function(e) {
          const t = (e, t) => function() {
            const n = e.apply(Ir, arguments);
            return '['.concat(n + t, 'm');
          }, n = (e, t) => function() {
            const n = e.apply(Ir, arguments);
          ...
          Object.defineProperty(e, 'exports', {
            enumerable: !0, get: function() {
              ...
              for (const t of Object.keys(o)) {
                ...
                Object.defineProperty(o, t, { value: n, enumerable: !1 }), Object.defineProperty(o, 'codes', {
                  value: e,
                  enumerable: !1
                });
              }
              ...
              for (let e of Object.keys(Ir)) {
                if ('object' != typeof Ir[e]) continue;
                const u = Ir[e];
        ...
        function Xr(e) {
          return 'u' === e[0] && 5 === e.length || 'x' === e[0] && 3 === e.length ? String.fromCharCode(parseInt(e.slice(1), 16)) : Gr.get(e) || e;
        }
        ...
        var Zr = (e, t) => {
          ...
          const t = Wr.stdout, n = 'win32' === Oe.platform && !(Oe.env.TERM || '').toLowerCase().startsWith('xterm'),
            r = ['ansi', 'ansi', 'ansi256', 'ansi16m'], o = new Set(['gray']), u = Object.create(null);
          ...
          n && (Mr.blue.open = '[94m');
          for (const e of Object.keys(Mr)) Mr[e].closeRe = new RegExp(kr(Mr[e].close), 'g'), u[e] = {
            get() {
              const t = Mr[e];
          ...
          }, Mr.color.closeRe = new RegExp(kr(Mr.color.close), 'g');
          for (const e of Object.keys(Mr.color.ansi)) o.has(e) || (u[e] = {
            get() {
              const t = this.level;
              return function() {
                const n = {
                  open: Mr.color[r[t]][e].apply(null, arguments),
                  close: Mr.color.close,
                  closeRe: Mr.color.closeRe
                };
                return c.call(this, this._styles ? this._styles.concat(n) : [n], this._empty, e);
              };
            }
          });
          Mr.bgColor.closeRe = new RegExp(kr(Mr.bgColor.close), 'g');
          for (const e of Object.keys(Mr.bgColor.ansi)) o.has(e) || (u['bg' + e[0].toUpperCase() + e.slice(1)] = {
            get() {
              const t = this.level;
              return function() {
                const n = {
                  open: Mr.bgColor[r[t]][e].apply(null, arguments),
                  close: Mr.bgColor.close,
                  closeRe: Mr.bgColor.closeRe
                };
                return c.call(this, this._styles ? this._styles.concat(n) : [n], this._empty, e);
              };
            }
          ...
          function c(e, t, n) {
            ...
            return Object.defineProperty(r, 'level', {
              enumerable: !0, get: () => o.level, set(e) {
                o.level = e;
              }
            }), Object.defineProperty(r, 'enabled', {
              enumerable: !0, get: () => o.enabled, set(e) {
                o.enabled = e;
              }
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), t.commonDeprecatedHandler = (e, t, { descriptor: n }) => {
            const r = [''.concat(eo.default.yellow('string' == typeof e ? n.key(e) : n.pair(e)), ' is deprecated')];
            return t && r.push('we now treat it as '.concat(eo.default.blue('string' == typeof t ? n.key(t) : n.pair(t)))), r.join('; ') + '.';
          };
        })), no = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(to, t);
        })), ro = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), t.commonInvalidHandler = (e, t, n) => ['Invalid '.concat(eo.default.red(n.descriptor.key(e)), ' value.'), 'Expected '.concat(eo.default.blue(n.schemas[e].expected(n)), ','), 'but received '.concat(eo.default.red(n.descriptor.value(t)), '.')].join(' ');
        })), oo = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(ro, t);
        })), uo = [], io = [], ao = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), t.levenUnknownHandler = (e, t, {
            descriptor: n,
            logger: r,
            schemas: o
          }) => {
            const u = ['Ignored unknown option '.concat(eo.default.yellow(n.pair({ key: e, value: t })), '.')],
              i = Object.keys(o).sort().find((t => function(e, t) {
                ...
                for (; p < o;) for (u = t.charCodeAt(c + p), a = p++, i = p, l = 0; l < r; l++) s = u === io[c + l] ? a : a + 1, a = uo[l], i = uo[l] = a > i ? s > i ? i + 1 : s : s > a ? a + 1 : s;
                return i;
              }(e, t) < 3));
            i && u.push('Did you mean '.concat(eo.default.blue(n.key(i)), '?')), r.warn(u.join(' '));
          };
        })), so = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(ao, t);
        })), co = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(no, t), Sr.__exportStar(oo, t), Sr.__exportStar(so, t);
        })), lo = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 });
          ...
          function n(e, t) {
            return 'string' == typeof e || 'key' in e ? { from: t, to: e } : 'from' in e ? {
              from: e.from,
              to: e.to
            } : { from: t, to: e.to };
          }
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), t.recordFromArray = function(e, t) {
            ...
            return 0 === n.length ? {
              remain: t,
              redirect: n
            } : 'object' == typeof e && 'remain' in e ? { remain: e.remain, redirect: n } : { redirect: n };
          };
        })), Do = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 });
          ...
          class n extends lo.Schema {
            constructor(e) {
              super(e), this._choices = go.mapFromArray(e.choices.map((e => e && 'object' == typeof e ? e : { value: e })), 'value');
            }
          ...
          class n extends yo.NumberSchema {
            ...
            validate(e, t) {
              return !0 === t.normalizeValidateResult(super.validate(e, t), e) && go.isInt(e);
            }
          }
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(po, t), Sr.__exportStar(fo, t), Sr.__exportStar(ho, t), Sr.__exportStar(mo, t), Sr.__exportStar(Do, t), Sr.__exportStar(Eo, t), Sr.__exportStar(yo, t), Sr.__exportStar(Co, t);
        })), vo = Me((function(e, t) {
          Object.defineProperty(t, '__esModule', { value: !0 }), t.defaultDescriptor = wr.apiDescriptor, t.defaultUnknownHandler = ao.levenUnknownHandler, t.defaultInvalidHandler = oo.commonInvalidHandler, t.defaultDeprecatedHandler = to.commonDeprecatedHandler;
        })), Ao = Me((function(e, t) {
          ...
          class n {
            constructor(e, t) {
              const {
                logger: n = console,
                descriptor: r = vo.defaultDescriptor,
                unknown: o = vo.defaultUnknownHandler,
                invalid: u = vo.defaultInvalidHandler,
                deprecated: i = vo.defaultDeprecatedHandler
              } = t || {};
              this._utils = {
                descriptor: r,
                logger: n || {
                ...
                schemas: go.recordFromArray(e, 'name'),
                normalizeDefaultResult: go.normalizeDefaultResult,
                normalizeDeprecatedResult: go.normalizeDeprecatedResult,
                normalizeForwardResult: go.normalizeForwardResult,
                normalizeRedirectResult: go.normalizeRedirectResult,
                normalizeValidateResult: go.normalizeValidateResult
              }, this._unknownHandler = o, this._invalidHandler = u, this._deprecatedHandler = i, this.cleanHistory();
            }

            cleanHistory() {
              this._hasDeprecationWarned = go.createAutoChecklist();
            }
            ...
            _applyNormalization(e, t) {
              const n = [], [r, o] = go.partition(Object.keys(e), (e => e in this._utils.schemas));
              for (const o of r) {
                const r = this._utils.schemas[o], u = r.preprocess(e[o], this._utils),
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), Sr.__exportStar(Tr, t), Sr.__exportStar(co, t), Sr.__exportStar(bo, t), Sr.__exportStar(Ao, t), Sr.__exportStar(lo, t);
        }));
        const xo = [], So = [], wo = (e, t) => {
          if (e === t) return 0;
          const n = e;
          ...
          for (; p < o;) for (u = t.charCodeAt(c + p), a = p++, i = p, l = 0; l < r; l++) s = u === So[l] ? a : a + 1, a = xo[l], i = xo[l] = a > i ? s > i ? i + 1 : s : s > a ? a + 1 : s;
          return i;
        };
        var To = wo, Bo = wo;
        To.default = Bo;
        ...
        function Lo(e, t) {
          ...
          let r = Oo[t[e].parent][e], o = t[e].parent;
        ...
        Po.rgb.hsl = function(e) {
          ...
          let t, n, r, o, u;
          const i = e[0] / 255, a = e[1] / 255, s = e[2] / 255, c = Math.max(i, a, s), l = c - Math.min(i, a, s),
            p = function(e) {
              return (c - e) / 6 / l + .5;
            };
          ...
          const t = e[0], n = e[1];
          let r = e[2];
          const o = Po.rgb.hsl(e)[0], u = 1 / 255 * Math.min(t, Math.min(n, r));
          ...
          var o, u;
          return n;
        }, Po.keyword.rgb = function(e) {
          return ko[e];
        }, Po.rgb.xyz = function(e) {
          ...
          let r = e[2] / 100;
          const o = Math.floor(t) % 6, u = t - Math.floor(t), i = 255 * r * (1 - n), a = 255 * r * (1 - n * u),
            s = 255 * r * (1 - n * (1 - u));
          switch (r *= 255, o) {
            case 0:
              return [r, s, i];
        ...
        }, Po.rgb.ansi16 = function(e, t = null) {
          const [n, r, o] = e;
          let u = null === t ? Po.rgb.hsv(e)[2] : t;
          if (u = Math.round(u / 50), 0 === u) return 30;
          let i = 30 + (Math.round(o / 255) << 2 | Math.round(r / 255) << 1 | Math.round(n / 255));
          return 2 === u && (i += 60), i;
        }, Po.hsv.ansi16 = function(e) {
          return Po.rgb.ansi16(Po.hsv.rgb(e), e[2]);
        }, Po.rgb.ansi256 = function(e) {
          const t = e[0], n = e[1], r = e[2];
          return t === n && n === r ? t < 8 ? 16 : t > 248 ? 231 : Math.round((t - 8) / 247 * 24) + 232 : 16 + 36 * Math.round(t / 255 * 5) + 6 * Math.round(n / 255 * 5) + Math.round(r / 255 * 5);
        }, Po.ansi16.rgb = function(e) {
          let t = e % 10;
          if (0 === t || 7 === t) return e > 50 && (t += 3.5), t = t / 10.5 * 255, [t, t, t];
          const n = .5 * (1 + ~~(e > 50));
          return [(1 & t) * n * 255, (t >> 1 & 1) * n * 255, (t >> 2 & 1) * n * 255];
        }, Po.ansi256.rgb = function(e) {
          if (e >= 232) {
            const t = 10 * (e - 232) + 8;
            return [t, t, t];
          }
          ...
          const t = e[0] / 255, n = e[1] / 255, r = e[2] / 255, o = Math.max(Math.max(t, n), r),
            u = Math.min(Math.min(t, n), r), i = o - u;
          let a, s;
          ...
          let o = 0;
          return r < 1 && (o = (n - r) / (1 - r)), [e[0], 100 * r, 100 * o];
        }, Po.apple.rgb = function(e) {
          return [e[0] / 65535 * 255, e[1] / 65535 * 255, e[2] / 65535 * 255];
        }, Po.rgb.apple = function(e) {
          return [e[0] / 255 * 65535, e[1] / 255 * 65535, e[2] / 255 * 65535];
        }, Po.gray.rgb = function(e) {
          return [e[0] / 100 * 255, e[0] / 100 * 255, e[0] / 100 * 255];
        }, Po.gray.hsl = function(e) {
          return [0, 0, e[0]];
        }, Po.gray.hsv = Po.gray.hsl, Po.gray.hwb = function(e) {
          return [0, 100, e[0]];
        }, Po.gray.cmyk = function(e) {
          return [0, 0, 0, e[0]];
        }, Po.gray.lab = function(e) {
          return [e[0], 0, 0];
        }, Po.gray.hex = function(e) {
          const t = 255 & Math.round(e[0] / 100 * 255), n = ((t << 16) + (t << 8) + t).toString(16).toUpperCase();
          return '000000'.substring(n.length) + n;
        }, Po.rgb.gray = function(e) {
          return [(e[0] + e[1] + e[2]) / 3 / 255 * 100];
        };
        const Io = {};
          ...
          Object.defineProperty(e, 'exports', {
            enumerable: !0, get: function() {
              ...
              return Object.defineProperty(a, 'codes', {
                value: e,
                enumerable: !1
              }), a.color.close = '[39m', a.bgColor.close = '[49m', i(a.color, 'ansi', (() => s(t, 'ansi16', o, !1))), i(a.color, 'ansi256', (() => s(n, 'ansi256', o, !1))), i(a.color, 'ansi16m', (() => s(r, 'rgb', u, !1))), i(a.bgColor, 'ansi', (() => s(t, 'ansi16', o, !0))), i(a.bgColor, 'ansi256', (() => s(n, 'ansi256', o, !0))), i(a.bgColor, 'ansi16m', (() => s(r, 'rgb', u, !0))), a;
            }
          });
        })), Ro = (e, t = Oe.argv) => {
          const n = e.startsWith('-') ? '' : 1 === e.length ? '-' : '--', r = t.indexOf(n + e), o = t.indexOf('--');
        ...
        var Jo = {
          supportsColor: function(e) {
            return Wo(Uo(e, e && e.isTTY));
          }, stdout: Wo(Uo(!0, qo.isatty(1))), stderr: Wo(Uo(!0, qo.isatty(2)))
        };
        ...
        const { stdout: nu, stderr: ru } = Jo, {
          stringReplaceAll: ou,
          stringEncaseCRLFWithFirstIndex: uu
        } = {
        ...
        const lu = e => {
          ...
          })(t, e), t.template = (...e) => yu(t.template, ...e), Object.setPrototypeOf(t, pu.prototype), Object.setPrototypeOf(t.template, t), t.template.constructor = () => {
            throw new Error('`chalk.constructor()` is deprecated. Use `new chalk.Instance()` instead.');
          }, t.template.Instance = cu, t.template;
        };
        ...
        for (const [e, t] of Object.entries(jo)) su[e] = {
          get() {
        ...
        for (const e of du) su[e] = {
          get() {
            const { level: t } = this;
            return function(...n) {
              const r = hu(jo.color[au[t]][e](...n), jo.color.close, this._styler);
              return mu(this, r, this._isEmpty);
            };
          }
        };
        for (const e of du) su['bg' + e[0].toUpperCase() + e.slice(1)] = {
          get() {
            const { level: t } = this;
            return function(...n) {
              const r = hu(jo.bgColor[au[t]][e](...n), jo.bgColor.close, this._styler);
              return mu(this, r, this._isEmpty);
            };
          }
        };
        const fu = Object.defineProperties((() => {
          ...
          if (-1 !== t.indexOf('')) for (; void 0 !== n;) t = ou(t, n.close, n.open), n = n.parent;
          const u = t.indexOf('\n');
        ...
        var Cu = Eu, bu = function(e, t) {
            for (var n = -1, r = t.length, o = e.length; ++n < r;) e[o + n] = t[n];
            return e;
          }, vu = 'object' == typeof Ie && Ie && Ie.Object === Object && Ie,
          Au = 'object' == typeof self && self && self.Object === Object && self,
          Fu = (vu || Au || Function('return this')()).Symbol, xu = Object.prototype, Su = xu.hasOwnProperty,
          wu = xu.toString, Tu = Fu ? Fu.toStringTag : void 0, Bu = Object.prototype.toString,
          ku = Fu ? Fu.toStringTag : void 0, Nu = function(e) {
            return null == e ? void 0 === e ? '[object Undefined]' : '[object Null]' : ku && ku in Object(e) ? function(e) {
              var t = Su.call(e, Tu), n = e[Tu];
              try {
                e[Tu] = void 0;
                var r = !0;
              } catch (e) {
            ...
            return Pu(e) && '[object Arguments]' == Nu(e);
          }, _u = Object.prototype, Lu = _u.hasOwnProperty, Iu = _u.propertyIsEnumerable, Mu = Ou(function() {
            return arguments;
          }()) ? Ou : function(e) {
            return Pu(e) && Lu.call(e, 'callee') && !Iu.call(e, 'callee');
          }, ju = Array.isArray, Ru = Fu ? Fu.isConcatSpreadable : void 0, qu = function(e) {
            return ju(e) || Mu(e) || !!(Ru && e && e[Ru]);
            ...
            return null != e && e.length ? Vu(e, 1) : [];
          };
        const Wu = {
          key: e => 1 === e.length ? '-'.concat(e) : '--'.concat(e),
          value: e => Fo.apiDescriptor.value(e),
          pair: ({
                   key: e,
                   value: t
                 }) => !1 === t ? '--no-'.concat(e) : !0 === t ? Wu.key(e) : '' === t ? ''.concat(Wu.key(e), ' without an argument') : ''.concat(Wu.key(e), '=').concat(t)
        };
        ...
        class Uu extends Fo.ChoiceSchema {
          ...
          preprocess(e, t) {
            if ('string' == typeof e && 0 !== e.length && !this._flags.includes(e)) {
              const n = this._flags.find((t => To(t, e) < 3));
        ...
        function zu(t, n, { logger: r, isCLI: o = !1, passThrough: u = !1 } = {}) {
          const i = u ? Array.isArray(u) ? (e, t) => u.includes(e) ? { [e]: t } : void 0 : (e, t) => ({ [e]: t }) : (t, n, r) => {
            const o = e(r.schemas, ['_']);
            return Fo.levenUnknownHandler(t, n, Object.assign({}, r, { schemas: o }));
          }, a = o ? Wu : Fo.apiDescriptor, s = function(e, { isCLI: t }) {
            const n = [];
            t && n.push(Fo.AnySchema.create({ name: '_' }));
            for (const r of e) n.push(Hu(r, {
              isCLI: t,
              optionInfos: e
            })), r.alias && t && n.push(Fo.AliasSchema.create({ name: r.alias, sourceName: r.name }));
            return n;
          }(n, { isCLI: o }), c = new Fo.Normalizer(s, { logger: r, unknown: i, descriptor: a }), l = !1 !== r;
        ...
        function Hu(e, { isCLI: t, optionInfos: n }) {
          ...
          switch (e.type) {
            ...
            case'string':
              ...
              break;
            case'choice':
              r = Fo.ChoiceSchema, o.choices = e.choices.map((t => 'object' == typeof t && t.redirect ? Object.assign({}, t, {
                redirect: {
                  to: {
                    key: e.name,
                    value: t.redirect
        ...
        function Yu(e) {
          ...
          return e.typeAnnotation ? Math.max(t, Yu(e.typeAnnotation)) : t;
        }
        ...
        var Qu = {
          locStart: Xu, locEnd: Yu, composeLoc: function(e, t = e) {
            const n = Xu(e);
            return [n, 'number' == typeof t ? n + t : Yu(t)];
          }, hasSameLocStart: Ku, hasSameLoc: function(e, t) {
            return Ku(e, t) && function(e, t) {
              return Yu(e) === Yu(t);
            }(e, t);
          }
        }, Zu = Me((function(e, t) {
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), t.isReservedWord = u, t.isStrictReservedWord = i, t.isStrictBindOnlyReservedWord = a, t.isStrictBindReservedWord = function(e, t) {
            return i(e, t) || a(e);
          ...
          r.rgb.hsl = function(e) {
            ...
            if (n) return n;
            var r, o, u, i = 1 / 0;
            for (var a in ui) if (ui.hasOwnProperty(a)) {
        ...
        function si(e, t) {
          for (var n = [t[e].parent, e], r = ii[t[e].parent][e], o = t[e].parent; t[o].parent;) n.unshift(t[o].parent), r = ai(ii[t[o].parent][o], r), o = t[o].parent;
          return r.conversion = n, r;
        }
        ...
        Object.keys(ii).forEach((function(e) {
          ...
          var t = function(e) {
            for (var t = function(e) {
              var t = function() {
                for (var e = {}, t = Object.keys(ii), n = t.length, r = 0; r < n; r++) e[t[r]] = {
                  distance: -1,
                  parent: null
                };
                return e;
              }(), n = [e];
              for (t[e].distance = 0; n.length;) for (var r = n.pop(), o = Object.keys(ii[r]), u = o.length, i = 0; i < u; i++) {
                var a = o[i], s = t[a];
                -1 === s.distance && (s.distance = t[r].distance + 1, s.parent = r, n.unshift(a));
              }
              return t;
        ...
        var li = ci, pi = Me((function(e) {
          const t = (e, t) => function() {
            const n = e.apply(li, arguments);
            return '['.concat(n + t, 'm');
          }, n = (e, t) => function() {
            const n = e.apply(li, arguments);
            return '['.concat(38 + t, ';5;').concat(n, 'm');
          ...
          Object.defineProperty(e, 'exports', {
            enumerable: !0, get: function() {
              ...
              const u = e => e, i = (e, t, n) => [e, t, n];
              o.color.close = '[39m', o.bgColor.close = '[49m', o.color.ansi = { ansi: t(u, 0) }, o.color.ansi256 = { ansi256: n(u, 0) }, o.color.ansi16m = { rgb: r(i, 0) }, o.bgColor.ansi = { ansi: t(u, 10) }, o.bgColor.ansi256 = { ansi256: n(u, 10) }, o.bgColor.ansi16m = { rgb: r(i, 10) };
              for (let e of Object.keys(li)) {
                if ('object' != typeof li[e]) continue;
                const u = li[e];
                'ansi16' === e && (e = 'ansi'), 'ansi16' in u && (o.color.ansi[e] = t(u.ansi16, 0), o.bgColor.ansi[e] = t(u.ansi16, 10)), 'ansi256' in u && (o.color.ansi256[e] = n(u.ansi256, 0), o.bgColor.ansi256[e] = n(u.ansi256, 10)), 'rgb' in u && (o.color.ansi16m[e] = r(u.rgb, 0), o.bgColor.ansi16m[e] = r(u.rgb, 10));
              }
              return o;
        ...
        function bi(e) {
          return 'u' === e[0] && 5 === e.length || 'x' === e[0] && 3 === e.length ? String.fromCharCode(parseInt(e.slice(1), 16)) : Ci.get(e) || e;
        }
        ...
        var xi = (e, t) => {
          ...
          const t = mi.stdout, n = 'win32' === Oe.platform && !(Oe.env.TERM || '').toLowerCase().startsWith('xterm'),
            r = ['ansi', 'ansi', 'ansi256', 'ansi16m'], o = new Set(['gray']), u = Object.create(null);
          ...
          n && (pi.blue.open = '[94m');
          for (const e of Object.keys(pi)) pi[e].closeRe = new RegExp(oi(pi[e].close), 'g'), u[e] = {
            get() {
              const t = pi[e];
              return c.call(this, this._styles ? this._styles.concat(t) : [t], this._empty, e);
            }
          ...
          }, pi.color.closeRe = new RegExp(oi(pi.color.close), 'g');
          for (const e of Object.keys(pi.color.ansi)) o.has(e) || (u[e] = {
            get() {
              const t = this.level;
              return function() {
                const n = {
                  open: pi.color[r[t]][e].apply(null, arguments),
                  close: pi.color.close,
                  closeRe: pi.color.closeRe
                };
                return c.call(this, this._styles ? this._styles.concat(n) : [n], this._empty, e);
              };
            }
          ...
          for (const e of Object.keys(pi.bgColor.ansi)) o.has(e) || (u['bg' + e[0].toUpperCase() + e.slice(1)] = {
            get() {
              const t = this.level;
              return function() {
                const n = {
                  open: pi.bgColor[r[t]][e].apply(null, arguments),
                  close: pi.bgColor.close,
                  closeRe: pi.bgColor.closeRe
                };
                return c.call(this, this._styles ? this._styles.concat(n) : [n], this._empty, e);
              };
            }
            ...
            return c(t) ? function(e, t) {
              return t.replace(r.default, (function(...t) {
                const n = function(e) {
                  ...
                  if ('name' === o.type) {
                    if ((0, ni.isKeyword)(o.value) || (0, ni.isReservedWord)(o.value)) return 'keyword';
                    if (a.test(o.value) && ('<' === n[t - 1] || '</' == n.substr(t - 2, 2))) return 'jsx_tag';
                    if (o.value[0] !== o.value[0].toLowerCase()) return 'capitalized';
                  }
                  return 'punctuator' === o.type && s.test(o.value) ? 'bracket' : 'invalid' !== o.type || '@' !== o.value && '#' !== o.value ? o.type : 'punctuator';
                }(t), o = e[n];
          ...
          }(Zu), o = (n = Si) && n.__esModule ? n : { default: n };
          ...
          function i(e, t, r = {}) {
            const o = (r.highlightCode || r.forceColor) && (0, n.shouldHighlight)(r), i = (0, n.getChalk)(r),
              a = function(e) {
                return { gutter: e.grey, marker: e.red.bold, message: e.red.bold };
              }(i), s = (e, t) => o ? e(t) : t, c = e.split(u), {
                start: l,
                end: p,
                markerLines: d
              } = function(e, t, n) {
                const r = Object.assign({ column: 0, line: -1 }, e.start),
                  o = Object.assign({}, r, e.end), { linesAbove: u = 2, linesBelow: i = 3 } = n || {}, a = r.line,
                  s = r.column, c = o.line, l = o.column;
        ...
        const { ConfigError: ki } = Cr, { locStart: Ni, locEnd: Pi } = Qu, Oi = Object.getOwnPropertyNames,
          _i = Object.getOwnPropertyDescriptor;

        function Li(e) {
          const t = {};
          for (const n of e.plugins) if (n.parsers) for (const e of Oi(n.parsers)) Object.defineProperty(t, e, _i(n.parsers, e));
          return t;
        }

        function Ii(e, t) {
          if (t = t || Li(e), 'function' == typeof e.parser) return {
            parse: e.parser,
            astFormat: 'estree',
            locStart: Ni,
            locEnd: Pi
          ...
          if ('string' == typeof e.parser) {
            ...
            throw new ki('Couldn\'t resolve parser "'.concat(e.parser, '". Parsers must be explicitly added to the standalone bundle.'));
          }
        }

        var Mi = {
          parse: function(e, t) {
            const n = Li(t), r = Object.keys(n).reduce(((e, t) => Object.defineProperty(e, t, {
              enumerable: !0,
              get: () => n[t].parse
            })), {}), o = Ii(t, n);
            try {
        ...
        const { UndefinedParserError: ji } = Cr, { getSupportInfo: Ri } = gt, { resolveParser: qi } = Mi,
          Vi = { astFormat: 'estree', printer: {}, originalText: void 0, locStart: null, locEnd: null };

        function $i(e, t) {
          const n = Bi.basename(e).toLowerCase(), r = Ri({ plugins: t }).languages.filter((e => null !== e.since));
              ...
              try {
                const n = new class {
                  ...
                  next() {
                    if (!this.fd) return !1;
                    let e, t = !1;
                    return this.eofReached && 0 === this.linesCache.length || (this.linesCache.length || (e = this._readChunk()), this.linesCache.length && (t = this.linesCache.shift(), t[t.length - 1] !== this.newLineCharacter && (e = this._readChunk(t), e && (t = this.linesCache.shift()))), this.eofReached && 0 === this.linesCache.length && this.close(), t && t[t.length - 1] === this.newLineCharacter && (t = t.slice(0, t.length - 1))), t;
                  }
                }(t).next().toString('utf8'), r = n.match(/^#!\/(?:usr\/)?bin\/env\s+(\S+)/);
                if (r) return r[1];
        ...
        var Wi = {
          normalize: function(e, t) {
            ...
            if (!n.parser) if (n.filepath) {
              if (n.parser = $i(n.filepath, n.plugins), !n.parser) throw new ji('No parser could be inferred for file: '.concat(n.filepath));
            ...
            return Object.keys(s).forEach((e => {
              null == n[e] && (n[e] = s[e]);
            })), 'json' === n.parser && (n.trailingComma = 'none'), Gu(n, r, Object.assign({ passThrough: Object.keys(Vi) }, t));
          }, hiddenDefaults: Vi, inferParser: $i
        }, Ui = function e(t, n, r) {
        ...
        const {
          ...
          skipNewline: na,
          skipSpaces: ra,
          isPreviousLineEmpty: oa,
          addLeadingComment: ua,
          addDanglingComment: ia,
          addTrailingComment: aa
        } = Lt, sa = Symbol('child-nodes');
        ...
        function ca(e, t, n) {
          ...
          return i ? (n || Object.defineProperty(e, sa, { value: n = [], enumerable: !1 }), i.forEach((e => {
            ca(e, t, n);
          })), n) : void 0;
        }
        ...
        function ha(e, t, n) {
          return e.getNode() === t.cursorNode && e.getValue() ? Hi([ea, n, ea]) : n;
        }
          ...
          attach: function(e, t, n, r) {
            ...
            e.forEach(((a, s) => {
              if ('json' === r.parser || 'json5' === r.parser || '__js_expression' === r.parser || '__vue_expression' === r.parser) {
                if (u(a) - u(t) <= 0) return void ua(t, a);
                if (i(a) - i(t) >= 0) return void aa(t, a);
              }
              la(t, a, r);
              const { precedingNode: c, enclosingNode: l, followingNode: p } = a,
                ...
                m = e.length - 1 === s;
              if (ta(n, u(a), { backwards: !0 })) d(a, n, r, t, m) || (p ? ua(p, a) : c ? aa(c, a) : ia(l || t, a)); else if (ta(n, i(a))) f(a, n, r, t, m) || (c ? aa(c, a) : p ? ua(p, a) : ia(l || t, a)); else if (h(a, n, r, t, m)) ; else if (c && p) {
                const e = o.length;
                e > 0 && o[e - 1].followingNode !== a.followingNode && pa(o, n, r), o.push(a);
              } else c ? aa(c, a) : p ? ua(p, a) : ia(l || t, a);
            })), pa(o, n, r), e.forEach((e => {
            ...
            return e.each((e => {
              ...
              if (r) {
                const r = function(e, t) {
                  const n = e.getValue(), r = da(e, t);
                  if (!r) return '';
                  if (t.printer.isBlockComment && t.printer.isBlockComment(n)) {
                    const e = ta(t.originalText, t.locEnd(n)) ? ta(t.originalText, t.locStart(n), { backwards: !0 }) ? Xi : Gi : ' ';
                    return Hi([r, e]);
                  }
                  return Hi([r, Xi]);
                }(e, n);
                if (!r) return;
                a.push(r);
                const o = n.originalText, u = na(o, ra(o, n.locEnd(t)));
                ...
                if (ta(u, i(n), { backwards: !0 })) {
                  const e = oa(u, n, i);
                  return Qi(Hi([Xi, e ? Xi : '', r]));
                }
                let s = Hi([' ', r]);
            ...
            return u && u.comments ? (e.each((e => {
              const n = e.getValue();
              !n || n.leading || n.trailing || r && !r(n) || o.push(da(e, t));
            }), 'comments'), 0 === o.length ? '' : n ? Zi(Xi, o) : Ki(Hi([Xi, Zi(Xi, o)]))) : '';
          }, getSortedChildNodes: ca, ensureAllCommentsPrinted: function(e) {
            e && e.forEach((e => {
        ...
        var ya = class {
          ...
          callParent(e, t = 0) {
            const n = Da(this.stack, t + 1), r = this.stack.splice(n + 1), o = e(this);
        ...
        const va = cn, Aa = va.builders, { concat: Fa, hardline: xa, addAlignmentToDoc: Sa } = Aa, wa = va.utils;
        ...
        function Na(e, t, n, r, o = []) {
          if (!(t < n.locStart(e) || t > n.locEnd(e))) {
            for (const u of ma.getSortedChildNodes(e, n)) {
              const i = Na(u, t, n, r, [e, ...o]);
              if (i) return i;
            }
        ...
        var La = {
          calculateRange: function(e, t, n) {
            ...
            const i = Na(n, o, t, (e => _a(t, e))), a = Na(n, u, t, (e => _a(t, e)));
        ...
        const {
          printer: { printDocToString: Ia },
          debug: { printDocToDebug: Ma }
        } = cn, { getAlignmentSize: ja } = Lt, {
          guessEndOfLine: Ra,
          convertEndOfLineToChars: qa,
          countEndOfLineChars: Va,
          normalizeEndOfLine: $a
        } = It, Wa = Wi.normalize, Ua = Symbol('cursor');

        function Ja(e, t, n) {
          const r = t.comments;
          return r && (delete t.comments, ma.attach(r, t, e, n)), n[Symbol.for('comments')] = r || [], n[Symbol.for('tokens')] = t.tokens || [], n.originalText = e, r;
        }
        ...
        function za(e, t, n) {
          ...
          const u = Ja(o, r, t), i = ka(r, t, n), a = Ia(i, t);
          ...
          if (t.cursorOffset >= 0) {
            ...
            const s = n.split('');
            s.splice(r, 0, Ua);
            const c = i.split(''), l = z.diffArrays(s, c);
            let p = u;
            for (const e of l) if (e.removed) {
              if (e.value.includes(Ua)) break;
            } else p += e.count;
        ...
        function Ga(e, t) {
          ...
          return n = Ha(e, n, -1), r = Ha(e, r, 0), o = Ha(e, o, e.length), Object.assign({}, t, {
            cursorOffset: n,
            rangeStart: r,
            rangeEnd: o
          });
        ...
        function Xa(e, t) {
          ...
          return {
            hasBOM: i,
            text: e,
            options: Ga(e, Object.assign({}, t, { cursorOffset: n, rangeStart: r, rangeEnd: o, endOfLine: u }))
          };
        }

        function Ya(e, t) {
          let { hasBOM: n, text: r, options: o } = Xa(e, Wa(t));
          const u = Mi.resolveParser(o), i = !u.hasPragma || u.hasPragma(r);
          ...
          return o.rangeStart > 0 || o.rangeEnd < r.length ? a = function(e, t) {
            const { ast: n, text: r } = Mi.parse(e, t), { rangeStart: o, rangeEnd: u } = La.calculateRange(r, t, n),
              i = r.slice(o, u), a = Math.min(o, r.lastIndexOf('\n', o) + 1), s = r.slice(a, o).match(/^\s*/)[0],
              c = ja(s, t.tabWidth), l = za(i, Object.assign({}, t, {
                rangeStart: 0,
                rangeEnd: 1 / 0,
        ...
        var Ka = {
          formatWithCursor: Ya, parse(e, t, n) {
            const { text: r, options: o } = Xa(e, Wa(t)), u = Mi.parse(r, o);
            return n && (u.ast = Ui(u.ast, o)), u;
          }, formatAST(e, t) {
            t = Wa(t);
            const n = ka(e, t);
            return Ia(n, t);
          }, formatDoc: (e, t) => Ya(Ma(e), Object.assign({}, t, { parser: 'babel' })).formatted, printToDoc(e, t) {
            t = Wa(t);
            const { ast: n, text: r } = Mi.parse(e, t);
            return Ja(r, n, t), ka(n, t);
          }, printDocToString: (e, t) => Ia(e, Wa(t))
        };
        const {
          getMaxContinuousCount: Qa,
          getStringWidth: Za,
          getAlignmentSize: es,
          getIndentSize: ts,
          skip: ns,
          ...
          skipNewline: us,
          skipToLineEnd: is,
          skipEverythingButNewLine: as,
          skipInlineComment: ss,
          skipTrailingComment: cs,
          hasNewline: ls,
        ...
        const Ss = Me((function(e, t) {
            t.ast = As, t.code = Fs, t.keyword = xs;
          })).keyword.isIdentifierNameES5, {
            getLast: ws,
            hasNewline: Ts,
            hasNewlineInRange: Bs,
            skipWhitespace: ks
          } = Lt, { locStart: Ns, locEnd: Ps, hasSameLocStart: Os } = Qu, _s = '(?:(?=.)\\s)',
          Ls = new RegExp('^'.concat(_s, '*:')), Is = new RegExp('^'.concat(_s, '*::'));

        function Ms(e, t) {
          if (!e || 'object' != typeof e) return !1;
          if (Array.isArray(e)) return e.some((e => Ms(e, t)));
          const n = t(e);
          return 'boolean' == typeof n ? n : Object.keys(e).some((n => Ms(e[n], t)));
        }
        ...
        function nc(e) {
          return $s(e) && (tc.test(ic(e)) || !/\n/.test(ic(e)));
        }

        function rc(e, t) {
          return Hs(t) ? gc(t) : t.comments && t.comments.some((t => t.leading && Ts(e, Ps(t))));
        }
        ...
        function fc(e) {
          ...
          const t = [];
          return e.this && t.push(e.this), Array.isArray(e.parameters) ? t.push(...e.parameters) : Array.isArray(e.params) && t.push(...e.params), e.rest && t.push(e.rest), dc.set(e, t), t;
        }
        ...
        function gc(e) {
          return e && (e.comments && e.comments.length > 0 && e.comments.some((e => mc(e) && !e.unignore)) || e.prettierIgnore);
        }

        function Dc(e) {
          return gc(e.getValue());
        }
        ...
        var yc = {
          ...
          hasRestParameter: function(e) {
            if (e.rest) return !0;
            const t = fc(e);
            return t.length > 0 && 'RestElement' === ws(t).type;
          },
          ...
          getParentExportDeclaration: function(e) {
            ...
            return 'declaration' === e.getName() && Vs(t) ? t : null;
          },
          ...
          hasFlowAnnotationComment: function(e) {
            return e && Rs(e[0]) && Is.test(e[0].value);
          },
          hasFlowShorthandAnnotationComment: function(e) {
            return e.extra && e.extra.parenthesized && e.trailingComments && Rs(e.trailingComments[0]) && Ls.test(e.trailingComments[0].value);
          },
          ...
          hasNewlineBetweenOrAfterDecorators: function(e, t) {
            return Bs(t.originalText, Ns(e.decorators[0]), Ps(ws(e.decorators))) || Ts(t.originalText, Ps(ws(e.decorators)));
          },
          ...
          hasTrailingLineComment: function(e) {
            return e.comments && e.comments.some((e => e.trailing && !Rs(e)));
          },
          hasIgnoreComment: Dc,
          ...
          isJSXWhitespaceExpression: function(e) {
            return 'JSXExpressionContainer' === e.type && $s(e.expression) && ' ' === e.expression.value && !e.expression.comments;
          },
          ...
          isObjectTypePropertyAFunction: function(e) {
            return !('ObjectTypeProperty' !== e.type && 'ObjectTypeInternalSlot' !== e.type || 'FunctionTypeAnnotation' !== e.value.type || e.static || Xs(e));
          },
          isSimpleType: function(e) {
            return !(!e || ('GenericTypeAnnotation' !== e.type && 'TSTypeReference' !== e.type || e.typeParameters) && !Ks.has(e.type));
          },
          isSimpleNumber: oc,
          ...
          isStringPropSafeToUnquote: function(e, t) {
            return 'json' !== t.parser && Us(e.key) && ic(e.key).slice(1, -1) === e.key.value && (Ss(e.key.value) && !(('typescript' === t.parser || 'babel-ts' === t.parser) && 'ClassProperty' === e.type) || oc(e.key.value) && String(Number(e.key.value)) === e.key.value && ('babel' === t.parser || 'espree' === t.parser || 'meriyah' === t.parser));
          },
          isTemplateOnItsOwnLine: function(e, t) {
            return ('TemplateLiteral' === e.type && uc(e) || 'TaggedTemplateExpression' === e.type && uc(e.quasi)) && !Ts(t, Ns(e), { backwards: !0 });
          },
          isTestCall: function e(t, n) {
            if ('CallExpression' !== t.type) return !1;
            if (1 === t.arguments.length) {
              if (zs(t) && n && e(n)) return Js(t.arguments[0]);
              if ('Identifier' === (r = t).callee.type && /^(before|after)(Each|All)$/.test(r.callee.name) && 1 === r.arguments.length) return zs(t.arguments[0]);
            } else if ((2 === t.arguments.length || 3 === t.arguments.length) && ('Identifier' === t.callee.type && Qs.test(t.callee.name) || function(e) {
              return ('MemberExpression' === e.callee.type || 'OptionalMemberExpression' === e.callee.type) && 'Identifier' === e.callee.object.type && 'Identifier' === e.callee.property.type && Qs.test(e.callee.object.name) && ('only' === e.callee.property.name || 'skip' === e.callee.property.name);
            }(t)) && (function(e) {
              return 'TemplateLiteral' === e.type;
            }(t.arguments[0]) || Us(t.arguments[0]))) return !(t.arguments[2] && !Ws(t.arguments[2])) && ((2 === t.arguments.length ? Js(t.arguments[1]) : function(e) {
              return 'FunctionExpression' === e.type || 'ArrowFunctionExpression' === e.type && 'BlockStatement' === e.body.type;
            }(t.arguments[1]) && fc(t.arguments[1]).length <= 1) || zs(t.arguments[1]));
            var r;
            return !1;
          },
          isTheOnlyJSXElementInMarkdown: function(e, t) {
            ...
            const n = t.getNode();
            if (!n.expression || !Hs(n.expression)) return !1;
          ...
          isTypeAnnotationAFunction: function(e) {
            return !('TypeAnnotation' !== e.type && 'TSTypeAnnotation' !== e.type || 'FunctionTypeAnnotation' !== e.typeAnnotation.type || e.static || Os(e, e.typeAnnotation));
          },
          matchJsxWhitespaceRegex: ec,
          needsHardlineAfterDanglingComment: function(e) {
            if (!e.comments) return !1;
            const t = ws(e.comments.filter((e => !e.leading && !e.trailing)));
            return t && !Rs(t);
          },
          rawText: ic,
          returnArgumentHasLeadingComment: function(e, t) {
            ...
            if (js(t)) {
              let r, o = t;
              for (; r = (n = o).expressions ? n.expressions[0] : n.left || n.test || n.callee || n.object || n.tag || n.argument || n.expression;) if (o = r, rc(e.originalText, o)) return !0;
            }
            var n;
            return !1;
          },
          ...
          shouldFlatten: function(e, t) {
            return !(pc(t) !== pc(e) || '**' === e || ac[e] && ac[t] || '%' === t && sc[e] || '%' === e && sc[t] || t !== e && sc[t] && sc[e] || cc[e] && cc[t]);
          },
        ...
        const {
          ...
          getNextNonSpaceNonCommentCharacter: vc,
          hasNewlineInRange: Ac,
          addLeadingComment: Fc,
          addTrailingComment: xc,
          addDanglingComment: Sc,
          getNextNonSpaceNonCommentCharacterIndex: wc
        } = Lt, {
          isBlockComment: Tc,
          getFunctionParameters: Bc,
          isPrettierIgnoreComment: kc,
          isJSXNode: Nc,
          hasFlowShorthandAnnotationComment: Pc,
          hasFlowAnnotationComment: Oc,
          hasIgnoreComment: _c
        } = yc, { locStart: Lc, locEnd: Ic } = Qu;
        ...
        function jc(e, t) {
          'BlockStatement' === e.type ? Mc(e, t) : Fc(e, t);
        }

        function Rc(e, t) {
          const { precedingNode: n, enclosingNode: r, followingNode: o } = e;
          return !(!r || 'IfStatement' !== r.type || !o || (')' === vc(t, e, Ic) ? (xc(n, e), 0) : n === r.consequent && o === r.alternate ? ('BlockStatement' === n.type ? xc(n, e) : Sc(r, e), 0) : 'BlockStatement' === o.type ? (Mc(o, e), 0) : 'IfStatement' === o.type ? (jc(o.consequent, e), 0) : r.consequent !== o || (Fc(o, e), 0)));
        }

        function qc(e, t) {
          const { precedingNode: n, enclosingNode: r, followingNode: o } = e;
          return !(!r || 'WhileStatement' !== r.type || !o || (')' === vc(t, e, Ic) ? (xc(n, e), 0) : 'BlockStatement' === o.type ? (Mc(o, e), 0) : r.body !== o || (Fc(o, e), 0)));
        }

        function Vc(e) {
          const { precedingNode: t, enclosingNode: n, followingNode: r } = e;
          return !(!n || 'TryStatement' !== n.type && 'CatchClause' !== n.type || !r || ('CatchClause' === n.type && t ? (xc(t, e), 0) : 'BlockStatement' === r.type ? (Mc(r, e), 0) : 'TryStatement' === r.type ? (jc(r.finalizer, e), 0) : 'CatchClause' !== r.type || (jc(r.body, e), 0)));
        }
        ...
        function $c(e) {
          ...
          if (n && ('ClassDeclaration' === n.type || 'ClassExpression' === n.type || 'DeclareClass' === n.type || 'DeclareInterface' === n.type || 'InterfaceDeclaration' === n.type || 'TSInterfaceDeclaration' === n.type)) {
            ...
            if (r) for (const o of ['implements', 'extends', 'mixins']) if (n[o] && r === n[o][0]) return !t || t !== n.id && t !== n.typeParameters && t !== n.superClass ? Sc(n, e, o) : xc(t, e), !0;
          }
          return !1;
        }
        ...
        function Uc(e, t) {
          const { precedingNode: n, enclosingNode: r, followingNode: o } = e;
          if (n && 'FunctionTypeParam' === n.type && r && 'FunctionTypeAnnotation' === r.type && o && 'FunctionTypeParam' !== o.type) return xc(n, e), !0;
          if (n && ('Identifier' === n.type || 'AssignmentPattern' === n.type) && r && Xc(r) && ')' === vc(t, e, Ic)) return xc(n, e), !0;
          if (r && 'FunctionDeclaration' === r.type && o && 'BlockStatement' === o.type) {
            const n = (() => {
              const e = Bc(r);
              if (0 !== e.length) return bc(t, Ic(Ec(e)));
              const n = bc(t, Ic(r.id));
              return !1 !== n && bc(t, n + 1);
            })();
            if (Lc(e) > n) return Mc(o, e), !0;
          }
          return !1;
        }
        ...
        function Jc(e) {
          ...
          return !(!t || 'ImportSpecifier' !== t.type || (Fc(t, e), 0));
        }

        function zc(e) {
          const { enclosingNode: t } = e;
          return !(!t || 'LabeledStatement' !== t.type || (Fc(t, e), 0));
        }

        function Hc(e, t, n) {
          const { enclosingNode: r } = e;
          return t && t.body && 0 === t.body.length ? (n ? Sc(t, e) : Fc(t, e), !0) : !(!r || 'Program' !== r.type || 0 !== r.body.length || !r.directives || 0 !== r.directives.length || (n ? Sc(r, e) : Fc(r, e), 0));
        }

        function Gc(e) {
          const { enclosingNode: t, followingNode: n } = e;
          if (kc(e) && t && 'TSMappedType' === t.type && n && 'TSTypeParameter' === n.type && n.constraint) return t.prettierIgnore = !0, e.unignore = !0, !0;
        }
        ...
        function Yc(e) {
          return Tc(e) && '*' === e.value[0] && /@type\b/.test(e.value);
        }

        var Kc = {
          handleOwnLineComment: function(e, t, n, r, o) {
            return Gc(e) || Uc(e, t) || function(e) {
              const { enclosingNode: t, followingNode: n } = e;
              return !(!t || 'MemberExpression' !== t.type && 'OptionalMemberExpression' !== t.type || !n || 'Identifier' !== n.type || (Fc(t, e), 0));
            }(e) || Rc(e, t) || qc(e, t) || Vc(e) || $c(e) || Jc(e) || function(e) {
              const { enclosingNode: t } = e;
              return !(!t || 'ForInStatement' !== t.type && 'ForOfStatement' !== t.type || (Fc(t, e), 0));
            }(e) || function(e) {
              const { precedingNode: t, enclosingNode: n, followingNode: r } = e;
              return !n || 'UnionTypeAnnotation' !== n.type && 'TSUnionType' !== n.type ? (r && ('UnionTypeAnnotation' === r.type || 'TSUnionType' === r.type) && kc(e) && (r.types[0].prettierIgnore = !0, e.unignore = !0), !1) : (kc(e) && (r.prettierIgnore = !0, e.unignore = !0), !!t && (xc(t, e), !0));
            }(e) || Hc(e, r, o) || function(e, t) {
              const { precedingNode: n, enclosingNode: r } = e;
              return !!(n && 'ImportSpecifier' === n.type && r && 'ImportDeclaration' === r.type && Cc(t, Ic(e))) && (xc(n, e), !0);
            }(e, t) || function(e) {
              const { enclosingNode: t } = e;
              return !(!t || 'AssignmentPattern' !== t.type || (Fc(t, e), 0));
            }(e) || Wc(e, t) || zc(e);
          }, handleEndOfLineComment: function(e, t, n, r, o) {
            return function(e) {
              const { followingNode: t } = e;
              return !(!t || !Yc(e) || (Fc(t, e), 0));
            }(e) || Uc(e, t) || function(e, t) {
              const { precedingNode: n, enclosingNode: r, followingNode: o } = e, u = n && !Ac(t, Ic(n), Lc(e));
              return !(n && u || !r || 'ConditionalExpression' !== r.type && 'TSConditionalType' !== r.type || !o || (Fc(o, e), 0));
            }(e, t) || Jc(e) || Rc(e, t) || qc(e, t) || Vc(e) || $c(e) || zc(e) || function(e) {
              const { precedingNode: t, enclosingNode: n } = e;
              return !!(n && ('CallExpression' === n.type || 'OptionalCallExpression' === n.type) && t && n.callee === t && n.arguments.length > 0) && (Fc(n.arguments[0], e), !0);
            }(e) || function(e) {
              const { enclosingNode: t } = e;
              return !(!t || 'Property' !== t.type && 'ObjectProperty' !== t.type || (Fc(t, e), 0));
            }(e) || Hc(e, r, o) || function(e) {
              const { enclosingNode: t } = e;
              return !(!t || 'TypeAlias' !== t.type || (Fc(t, e), 0));
            }(e) || function(e) {
              const { enclosingNode: t, followingNode: n } = e;
              return !(!t || 'VariableDeclarator' !== t.type && 'AssignmentExpression' !== t.type || !n || 'ObjectExpression' !== n.type && 'ArrayExpression' !== n.type && 'TemplateLiteral' !== n.type && 'TaggedTemplateExpression' !== n.type && !Tc(e) || (Fc(n, e), 0));
            }(e);
          }, handleRemainingComment: function(e, t, n, r, o) {
            return !!(Gc(e) || Rc(e, t) || qc(e, t) || function(e) {
              const { precedingNode: t, enclosingNode: n } = e;
              return !(!n || 'ObjectProperty' !== n.type && 'Property' !== n.type || !n.shorthand || n.key !== t || 'AssignmentPattern' !== n.value.type || (xc(n.value.left, e), 0));
            }(e) || function(e, t) {
              if (')' !== vc(t, e, Ic)) return !1;
              const { enclosingNode: n } = e;
              return n && (Xc(n) && 0 === Bc(n).length || ('CallExpression' === n.type || 'OptionalCallExpression' === n.type || 'NewExpression' === n.type) && 0 === n.arguments.length) ? (Sc(n, e), !0) : !(!n || 'MethodDefinition' !== n.type || 0 !== Bc(n.value).length || (Sc(n.value, e), 0));
            }(e, t) || Wc(e, t) || Hc(e, r, o) || function(e, t) {
              const { enclosingNode: n } = e;
              if (!n || 'ArrowFunctionExpression' !== n.type) return !1;
              const r = wc(t, e, Ic);
              return !1 !== r && '=>' === t.slice(r, r + 2) && (Sc(n, e), !0);
            }(e, t) || function(e, t) {
              if ('(' !== vc(t, e, Ic)) return !1;
              const { precedingNode: n, enclosingNode: r } = e;
              return !(!n || !r || 'FunctionDeclaration' !== r.type && 'FunctionExpression' !== r.type && 'ClassMethod' !== r.type && 'MethodDefinition' !== r.type && 'ObjectMethod' !== r.type || (xc(n, e), 0));
            }(e, t) || function(e) {
              const { precedingNode: t, enclosingNode: n, followingNode: r } = e;
              return !(!n || 'TSMappedType' !== n.type || (r && 'TSTypeParameter' === r.type && r.name ? (Fc(r.name, e), 0) : !t || 'TSTypeParameter' !== t.type || !t.constraint || (xc(t.constraint, e), 0)));
            }(e) || function(e) {
              const { enclosingNode: t } = e;
              return !(!t || 'ContinueStatement' !== t.type && 'BreakStatement' !== t.type || t.label || (xc(t, e), 0));
            }(e) || function(e, t) {
              const { enclosingNode: n, followingNode: r } = e;
              return !(r || !n || 'TSMethodSignature' !== n.type && 'TSDeclareFunction' !== n.type && 'TSAbstractMethodDefinition' !== n.type || ';' !== vc(t, e, Ic) || (xc(n, e), 0));
            }(e, t));
          ...
          }, isTypeCastComment: Yc, getGapRegex: function(e) {
            if (e && 'BinaryExpression' !== e.type && 'LogicalExpression' !== e.type) return /^[\s&(|]*$/;
          }, getCommentChildNodes: function(e, t) {
            if (('typescript' === t.parser || 'flow' === t.parser || 'espree' === t.parser || 'meriyah' === t.parser) && 'MethodDefinition' === e.type && e.value && 'FunctionExpression' === e.value.type && 0 === Bc(e.value).length && !e.value.returnType && (!e.value.typeParameters || 0 === e.value.typeParameters.length) && e.value.body) return [...e.decorators || [], e.key, e.value.body];
        ...
        const { getStringWidth: Qc, getIndentSize: Zc } = Lt, {
          builders: {
            concat: el,
            join: tl,
            hardline: nl,
            ...
            indent: ul,
            align: il,
            lineSuffixBoundary: al,
            addAlignmentToDoc: sl
          }, printer: { printDocToString: cl }, utils: { mapDoc: ll }
        } = cn, { isBinaryish: pl, isJestEachTemplateLiteral: dl, isSimpleTemplateLiteral: fl } = yc;
        ...
        var ml = {
          printTemplateLiteral: function(e, t, n) {
            ...
            if ('TemplateLiteral' === r.type && dl(r, e.getParentNode())) {
              const r = function(e, t, n) {
                ...
                if (o.length > 1 || o.some((e => 0 !== e.length))) {
                  ...
                  t.__inJestEach = !1;
                  const i = [], a = u.map((e => '${' + cl(e, Object.assign({}, t, {
                    printWidth: 1 / 0,
                    endOfLine: 'lf'
                  })).formatted + '}')), s = [{ hasLineBreak: !1, cells: [] }];
                  ...
                  const c = Math.max(o.length, ...s.map((e => e.cells.length))), l = Array.from({ length: c }).fill(0),
                    p = [{ cells: o }, ...s.filter((e => 0 !== e.cells.length))];
                  for (const { cells: e } of p.filter((e => !e.hasLineBreak))) e.forEach(((e, t) => {
                    l[t] = Math.max(l[t], Qc(e));
                  }));
            ...
            return e.map((e => function(e, t) {
              const n = e.getValue();
              let r = t(e);
              return n.comments && n.comments.length && (r = ol(el([ul(el([rl, r])), rl]))), el(['${', r, al, '}']);
            }(e, t)), 'expressions');
          }, escapeTemplateCharacters: function(e, t) {
            return ll(e, (e => {
              if (!e.parts) return e;
              const n = e.parts.map((e => 'string' == typeof e ? t ? e.replace(/(\\*)`/g, '$1$1\\`') : hl(e) : e));
        ...
        } = cn, { escapeTemplateCharacters: bl } = ml;
        const {
          builders: { indent: vl, hardline: Al, softline: Fl, concat: xl },
          utils: { mapDoc: Sl, replaceNewlinesWithLiterallines: wl }
        } = cn, { printTemplateExpressions: Tl } = ml;
        const { builders: { indent: Bl, join: kl, hardline: Nl, concat: Pl } } = cn, {
          escapeTemplateCharacters: Ol,
        ...
        function Ll(e) {
          ...
          return e.map((e => e.trim())).forEach(((e, r, o) => {
            '' !== e && ('' === o[r - 1] && n ? t.push(Pl([Nl, e])) : t.push(e), n = !0);
          })), 0 === t.length ? null : kl(Nl, t);
        }

        const {
          builders: { indent: Il, line: Ml, hardline: jl, concat: Rl, group: ql },
          utils: { mapDoc: Vl }
        } = cn, { printTemplateExpressions: $l, uncookTemplateElementValue: Wl } = ml;
        let Ul = 0;
        ...
        function Yl(e, t) {
          return zl(e, (e => Jl(e) && e.value === ' '.concat(t, ' ')));
        }

        const { isBlockComment: Kl } = yc,
          Ql = new Set(['range', 'raw', 'comments', 'leadingComments', 'trailingComments', 'innerComments', 'extra', 'start', 'end', 'loc', 'flags', 'errors', 'tokens']);
        ...
        var rp = Me((function(e, t) {
          ...
          function r() {
            const e = (t = np) && t.__esModule ? t : { default: t };
            var t;
            return r = function() {
              return e;
            }, e;
        ...
        const {
          parseWithComments: op,
          strip: up,
          extract: ip,
          print: ap
        } = rp, { getShebang: sp } = Lt, { normalizeEndOfLine: cp } = It;

        function lp(e) {
          const t = sp(e);
          t && (e = e.slice(t.length + 1));
          const n = ip(e), { pragmas: r, comments: o } = op(n);
          return { shebang: t, text: e, pragmas: r, comments: o };
        }

        var pp = {
          hasPragma: function(e) {
            const t = Object.keys(lp(e).pragmas);
            return t.includes('prettier') || t.includes('format');
          }, insertPragma: function(e) {
            const { shebang: t, text: n, pragmas: r, comments: o } = lp(e), u = up(n),
              i = ap({ pragmas: Object.assign({ format: '' }, r), comments: o.trimStart() });
            return (t ? ''.concat(t, '\n') : '') + cp(i) + (u.startsWith('\n') ? '\n' : '\n\n') + u;
          }
        };
        const {
          getFunctionParameters: dp,
          getLeftSidePathName: fp,
          hasFlowShorthandAnnotationComment: hp,
          hasNakedLeftSide: mp,
          hasNode: gp,
          isBitwiseOperator: Dp,
          startsWithNoLookaheadToken: yp,
          shouldFlatten: Ep,
          getPrecedence: Cp
        } = yc;
        ...
        function bp(e, t) {
          ...
          switch (o.type) {
            ...
            case'LogicalExpression':
              switch (n.type) {
                ...
                case'BinaryExpression': {
                  ...
                  const u = Cp(e), i = n.operator, a = Cp(i);
            ...
            case'FunctionTypeAnnotation': {
              ...
              return 'UnionTypeAnnotation' === t.type || 'IntersectionTypeAnnotation' === t.type || 'ArrayTypeAnnotation' === t.type || 'NullableTypeAnnotation' === t.type || 'FunctionTypeParam' === n.type && null === n.name && dp(o).some((e => e.typeAnnotation && 'NullableTypeAnnotation' === e.typeAnnotation.type));
            }
            case'StringLiteral':
            case'NumericLiteral':
            case'Literal':
            ...
            case'TypeAnnotation':
              return 'returnType' === r && 'ArrowFunctionExpression' === n.type && function(e) {
                return gp(e, (e => 'ObjectTypeAnnotation' === e.type && gp(e, (e => 'FunctionTypeAnnotation' === e.type || void 0)) || void 0));
              }(o);
          }
          return !1;
        }
        ...
        var Np = {
          isVueEventBindingExpression: function e(t) {
            ...
            if (t.__onHtmlBindingRoot && null === e.getName() && t.__onHtmlBindingRoot(r, t), 'File' === r.type) return t.__isVueForBindingLeft ? e.call((e => {
              const t = Sp(xp([',', wp]), e.map(n, 'params')), { params: r } = e.getValue();
        ...
        } = cn, { hasNewlineBetweenOrAfterDecorators: Rp, getParentExportDeclaration: qp } = yc;
        var Vp = {
          printOptionalToken: function(e) {
            ...
            return Op(['::', e.call(n, 'callee')]);
          }, printTypeScriptModifiers: function(e, t, n) {
            const r = e.getValue();
            return r.modifiers && r.modifiers.length ? Op([Ip(' ', e.map(n, 'modifiers')), ' ']) : '';
          }, printDecorators: function(e, t, n) {
            const r = e.getValue();
            return _p(Op([Ip(Mp, e.map(n, 'decorators')), Rp(r, t) ? jp : Mp]));
          }, printFlowDeclaration: function(e, t) {
            const n = qp(e);
            return n ? (zi.strictEqual(n.type, 'DeclareExportDeclaration'), t) : Op(['declare ', t]);
          }, adjustClause: function(e, t, n) {
            return 'EmptyStatement' === e.type ? ';' : 'BlockStatement' === e.type || n ? Op([' ', t]) : Lp(Op([Mp, t]));
          }
        };
        const {
          builders: {
        ...
        } = cn, { printDanglingComments: Yp } = ma, {
          hasDanglingComments: Kp,
          shouldPrintComma: Qp,
          needsHardlineAfterDanglingComment: Zp
        } = yc, { locStart: ed, hasSameLoc: td } = Qu;

        function nd(e, t, n) {
          const r = e.getValue();
          if (!r.source) return '';
          const o = [];
          return od(r, t) || o.push(' from'), o.push(' ', e.call(n, 'source')), $p(o);
        }
        ...
        function od(e, t) {
          ...
          return !('ImportDeclaration' !== n || Array.isArray(u) && u.length > 0 || 'type' === r || /{\s*}/.test(t.originalText.slice(ed(e), ed(o))));
        }

        function ud(e, t, n) {
          const r = e.getNode();
          return Array.isArray(r.assertions) && 0 !== r.assertions.length ? $p([' assert {', t.bracketSpacing ? ' ' : '', zp(', ', e.map(n, 'assertions')), t.bracketSpacing ? ' ' : '', '}']) : '';
        }
        ...
        var id = {
          printImportDeclaration: function(e, t, n) {
            ...
            return 'DeclareExportDeclaration' === u && o.push('declare '), o.push('export'), (r.default || 'ExportDefaultDeclaration' === u) && o.push(' default'), Kp(r) && (o.push(' ', Yp(e, t, !0)), Zp(r) && o.push(Xp)), a ? o.push(' ', e.call(n, 'declaration')) : o.push('type' === i ? ' type' : '', rd(e, t, n), nd(e, t, n), ud(e, t, n)), function(e, t) {
              if (!t.semi) return !1;
              const { type: n, declaration: r } = e, o = e.default || 'ExportDefaultDeclaration' === n;
              if (!r) return !0;
              const { type: u } = r;
              return !(!o || 'ClassDeclaration' === u || 'FunctionDeclaration' === u || 'TSInterfaceDeclaration' === u || 'DeclareClass' === u || 'DeclareFunction' === u || 'TSDeclareFunction' === u || 'EnumDeclaration' === u);
            }(r, t) && o.push(';'), $p(o);
        ...
        const { hasNewlineInRange: ad } = Lt, { isJSXNode: sd, isBlockComment: cd } = yc, {
          locStart: ld,
          locEnd: pd
        } = Qu, {
          builders: {
        ...
        var bd = function(e, t, n, r) {
          ...
          const m = p || c, g = d;
          if (r.shouldCheckJsx && (sd(o[r.testNodePropertyNames[0]]) || sd(u) || sd(i) || function(e) {
            return function(e) {
              const t = [];
              return function e(n) {
        ...
        const {
          getNextNonSpaceNonCommentCharacter: vd,
          isNextLineEmpty: Ad
        } = Lt, { printDanglingComments: Fd } = ma, {
          builders: {
            concat: xd,
            line: Sd,
            hardline: wd,
            ...
            indent: kd,
            ifBreak: Nd
          }, utils: { removeLines: Pd }
        } = cn, {
          getFunctionParameters: Od,
          iterateFunctionParametersPath: _d,
          isSimpleType: Ld,
          isTestCall: Id,
          isTypeAnnotationAFunction: Md,
          isObjectType: jd,
          isObjectTypePropertyAFunction: Rd,
          hasRestParameter: qd,
          shouldPrintComma: Vd
        } = yc, { locEnd: $d } = Qu, { printFunctionTypeParameters: Wd } = Vp;
        ...
        var Jd = {
          printFunctionParameters: function(e, t, n, r, o) {
            const u = e.getValue(), i = Od(u), a = o ? Wd(e, n, t) : '';
            if (0 === i.length) return xd([a, '(', Fd(e, n, !0, (e => ')' === vd(n.originalText, e, $d))), ')']);
            const s = e.getParentNode(), c = Id(s), l = Ud(u), p = r && !i.some((e => e.comments)), d = [];
            if (_d(e, ((e, r) => {
        ...
        const { builders: { concat: zd } } = cn, {
          isFlowAnnotationComment: Hd,
          isSimpleType: Gd,
          isObjectType: Xd
        } = yc;
        var Yd = {
          printTypeAnnotation: function(e, t, n) {
            ...
            const o = e.getParentNode(), u = r.definite || o && 'VariableDeclarator' === o.type && o.definite,
        ...
        const { printDanglingComments: Kd } = ma, {
          builders: {
            concat: Qd,
            line: Zd,
            softline: ef,
        ...
        } = cn, { getLast: of, isNextLineEmpty: uf } = Lt, {
          hasDanglingComments: af,
          shouldPrintComma: sf
        } = yc, { locEnd: cf } = Qu, { printOptionalToken: lf } = Vp, { printTypeAnnotation: pf } = Yd;

        function df(e, t, n, r) {
          const o = [];
          let u = [];
          return e.each((e => {
            o.push(Qd(u)), o.push(tf(r(e))), u = [',', Zd], e.getValue() && uf(t.originalText, e.getValue(), cf) && u.push(ef);
          }), n), Qd(o);
        }
        ...
        var ff = {
          printArray: function(e, t, n) {
            ...
            if (0 === r.elements.length) af(r) ? o.push(tf(Qd([u, Kd(e, t), ef, ']']))) : o.push(u, ']'); else {
              const i = of(r.elements), a = !(i && 'RestElement' === i.type), s = a && null === i,
        ...
        const { printDanglingComments: hf } = ma, {
          builders: {
            concat: mf,
            line: gf,
            softline: Df,
          ...
          getLast: vf,
          isNextLineEmpty: Af,
          hasNewlineInRange: Ff,
          hasNewline: xf
        } = Lt, {
          hasDanglingComments: Sf,
          shouldPrintComma: wf,
          hasNodeIgnoreComment: Tf,
          isBlockComment: Bf
        } = yc, {
          locStart: kf,
          locEnd: Nf
        } = Qu, { printOptionalToken: Pf } = Vp, { shouldHugFunctionParameters: Of } = Jd, {
          printTypeAnnotation: _f,
          shouldHugType: Lf
        } = Yd;
        var If = {
          printObject: function(e, t, n) {
            ...
            const s = a.map((e => o[e][0])).sort(((e, t) => kf(e) - kf(t)))[0], c = e.getParentNode(0),
              ...
              f = 'RecordExpression' === o.type ? '#{' : o.exact ? '{|' : '{', h = o.exact ? '|}' : '}', m = [];
            a.forEach((t => {
              e.each((e => {
                const t = e.getValue();
            ...
            const D = m.sort(((e, t) => e.loc - t.loc)).map((e => {
              const n = mf(g.concat(yf(e.printed)));
              return g = [d, gf], 'TSPropertySignature' !== e.node.type && 'TSMethodSignature' !== e.node.type && 'TSConstructSignatureDeclaration' !== e.node.type || !Tf(e.node) || g.shift(), Af(t.originalText, e.node, Nf) && g.push(bf), n;
            }));
            if (o.inexact) {
              let n;
              if (Sf(o)) {
                const r = !o.comments.every((e => Bf(e))), u = hf(e, t, !0);
        ...
        const { printComments: Mf, printDanglingComments: jf } = ma, {
          builders: {
            concat: Rf,
            line: qf,
            hardline: Vf,
            ...
            fill: zf,
            ifBreak: Hf,
            lineSuffixBoundary: Gf
          }, utils: { willBreak: Xf, isLineNext: Yf, isEmpty: Kf }
        } = cn, { getLast: Qf, getPreferredQuote: Zf } = Lt, {
          hasTrailingComment: eh,
          isEmptyJSXElement: th,
          isJSXWhitespaceExpression: nh,
          isJSXNode: rh,
          isMeaningfulJSXText: oh,
          matchJsxWhitespaceRegex: uh,
          rawText: ih,
          isLiteral: ah,
          isCallOrOptionalCallExpression: sh,
          isStringLiteral: ch,
          isBinaryish: lh,
          isBlockComment: ph
        } = yc, { willPrintOwnComments: dh } = Kc;

        function fh(e, t, n, r) {
          return e ? '' : 'JSXElement' === n.type && !n.closingElement || r && 'JSXElement' === r.type && !r.closingElement ? 1 === t.length ? $f : Vf : $f;
        }

        function hh(e, t, n, r) {
          return e ? Vf : 1 === t.length ? 'JSXElement' === n.type && !n.closingElement || r && 'JSXElement' === r.type && !r.closingElement ? Vf : $f : Vf;
        }

        function mh(e, t, n) {
          const r = e.getValue();
          return Rf(['{', e.call((e => {
            const r = Rf(['...', n(e)]), o = e.getValue();
        ...
        var gh = {
          printJsxElement: function(e, t, n) {
            const r = Mf(e, (() => function(e, t, n) {
              ...
              let c = Xf(o) || i || s || a;
              const l = 'mdx' === e.getParentNode().rootMarker, p = t.singleQuote ? '{\' \'}' : '{" "}',
                d = l ? Rf([' ']) : Hf(Rf([p, $f]), ' '),
                ...
                }(e, 0, n, d, f), m = r.children.some((e => oh(e)));
              for (let e = h.length - 2; e >= 0; e--) {
                const t = '' === h[e] && '' === h[e + 1], n = h[e] === Vf && '' === h[e + 1] && h[e + 2] === Vf,
              ...
              h.forEach(((e, t) => {
                if (e === d) {
                  if (1 === t && '' === h[t - 1]) return 2 === h.length ? void g.push(p) : void g.push(Rf([p, Vf]));
                  if (t === h.length - 1) return void g.push(p);
                  if ('' === h[t - 1] && h[t - 2] === Vf) return void g.push(p);
                }
                g.push(e), Xf(e) && (c = !0);
              }));
            ...
            if (o.push(e.call(n, 'name')), r.value) {
              ...
              if (ch(r.value)) {
                ...
                const n = Zf(e, t.jsxSingleQuote ? '\'' : '"'), o = '\'' === n ? '&apos;' : '&quot;';
            ...
            const n = e.getValue(), r = n.comments && !n.comments.every((e => ph(e)));
            return Rf([jf(e, t, !r), r ? Vf : '']);
          }, printJsxSpreadAttribute: mh, printJsxSpreadChild: mh
        };
        const { printDanglingComments: Dh } = ma, {
          builders: {
            concat: yh,
            join: Eh,
            line: Ch,
          ...
          hasDanglingComments: Sh,
          isTestCall: wh,
          isBlockComment: Th,
          shouldPrintComma: Bh
        } = yc, { shouldHugType: kh } = Yd, Nh = new WeakMap;

        function Ph(e) {
          return Nh.has(e) || Nh.set(e, Symbol('typeParameters')), Nh.get(e);
        }

        function Oh(e, t) {
          const n = e.getValue();
          if (!Sh(n)) return '';
          const r = n.comments.every((e => Th(e))), o = Dh(e, t, r);
          return r ? o : yh([o, bh]);
        }
        ...
        var _h = {
          printTypeParameters: function(e, t, n, r) {
            ...
            const u = e.getNode(2);
            return null != u && wh(u) || 0 === o[r].length || 1 === o[r].length && (kh(o[r][0]) || 'GenericTypeAnnotation' === o[r][0].type && kh(o[r][0].id) || 'TSTypeReference' === o[r][0].type && kh(o[r][0].typeName) || 'NullableTypeAnnotation' === o[r][0].type) ? yh(['<', Eh(', ', e.map(n, r)), Oh(e, t), '>']) : Ah(yh(['<', Fh(yh([vh, Eh(yh([',', Ch]), e.map(n, r))])), xh('typescript' !== t.parser && 'babel-ts' !== t.parser && Bh(t, 'all') ? ',' : ''), vh, '>']), { id: Ph(o) });
          }, getTypeParametersGroupId: Ph
        };
        const { printComments: Lh } = ma, {
          printString: Ih,
          printNumber: Mh
        } = Lt, { builders: { concat: jh } } = cn, {
          isNumericLiteral: Rh,
          isSimpleNumber: qh,
          isStringLiteral: Vh,
          isStringPropSafeToUnquote: $h,
          rawText: Wh
        } = yc, Uh = new WeakMap;
        var Jh = {
          printPropertyKey: function(e, t, n) {
            ...
            if (('Identifier' === u.type || Rh(u) && qh(Mh(Wh(u))) && String(u.value) === Mh(Wh(u)) && 'typescript' !== t.parser && 'babel-ts' !== t.parser) && ('json' === t.parser || 'consistent' === t.quoteProps && Uh.get(o))) {
              const n = Ih(JSON.stringify('Identifier' === u.type ? u.name : u.value.toString()), t);
              return e.call((e => Lh(e, (() => n), t)), 'key');
            }
        ...
        const { printDanglingComments: zh } = ma, { getNextNonSpaceNonCommentCharacterIndex: Hh } = Lt, {
          builders: {
            concat: Gh,
            line: Xh,
            softline: Yh,
          ...
          getFunctionParameters: tm,
          hasDanglingComments: nm,
          hasLeadingOwnLineComment: rm,
          isFlowAnnotationComment: om,
          isJSXNode: um,
          isTemplateOnItsOwnLine: im,
          shouldPrintComma: am,
          startsWithNoLookaheadToken: sm,
          returnArgumentHasLeadingComment: cm,
          isBinaryish: lm,
          isLineComment: pm
        } = yc, { locEnd: dm } = Qu, { printFunctionParameters: fm } = Jd, { printPropertyKey: hm } = Jh, { printFunctionTypeParameters: mm } = Vp;

        function gm(e, t, n) {
          const r = [mm(e, t, n), Kh(Gh([fm(e, n, t), ym(e, n, t)]))];
          return e.getNode().body ? r.push(' ', e.call(n, 'body')) : r.push(t.semi ? ';' : ''), Gh(r);
        }

        function Dm(e, t) {
          return 'always' !== t.arrowParens && 'avoid' === t.arrowParens && function(e) {
            const t = tm(e);
            return !(1 !== t.length || e.typeParameters || nm(e) || 'Identifier' !== t[0].type || t[0].typeAnnotation || t[0].comments || t[0].optional || e.predicate || e.returnType);
          }(e.getValue());
        }
        ...
        var Em = {
          printFunctionDeclaration: function(e, t, n, r) {
            ...
            const i = zh(e, t, !0, (e => {
              const n = Hh(t.originalText, e, dm);
            ...
            const s = (r && r.expandLastArg || 'JSXExpressionContainer' === e.getParentNode().type) && !(o.comments && o.comments.length),
              c = r && r.expandLastArg && am(t, 'all'), l = 'ConditionalExpression' === o.body.type && !sm(o.body, !1);
            ...
            const i = Array.isArray(r.comments) && r.comments[r.comments.length - 1], a = i && pm(i);
            return a && u.push(o), nm(r) && u.push(' ', zh(e, t, !0)), a || u.push(o), Gh(u);
          }, shouldPrintParamsWithoutParens: Dm
        };
        const { printComments: Cm, printDanglingComments: bm } = ma, {
          builders: {
            concat: vm,
            join: Am,
            line: Fm,
          ...
          hasTrailingComment: km,
          hasTrailingLineComment: Nm
        } = yc, { getTypeParametersGroupId: Pm } = _h, { printMethod: Om } = Em, { printDecorators: _m } = Vp;

        function Lm(e) {
          return e.typeParameters && !Nm(e.typeParameters) && !function(e) {
        ...
        function Im(e, t, n, r) {
          ...
          const u = bm(e, t, !0, (({ marker: e }) => e === r));
          return vm([Lm(o) ? Bm(' ', Fm, { groupId: Pm(o.typeParameters) }) : Fm, u, u && xm, r, wm(Tm(vm([Fm, Am(vm([',', Fm]), e.map(n, r))])))]);
        }

        function Mm(e, t, n) {
          const r = e.call(n, 'superClass');
          return 'AssignmentExpression' === e.getParentNode().type ? wm(Bm(vm(['(', Tm(vm([Sm, r])), Sm, ')']), r)) : r;
        }
        ...
        const { getLast: Rm, getPenultimate: qm, isNextLineEmpty: Vm } = Lt, {
          getFunctionParameters: $m,
          iterateFunctionParametersPath: Wm,
          hasLeadingComment: Um,
          hasTrailingComment: Jm,
          isFunctionCompositionArgs: zm,
          isJSXNode: Hm,
          isLongCurriedCallExpression: Gm,
          shouldPrintComma: Xm,
          getCallArguments: Ym,
          iterateCallArgumentsPath: Km
        } = yc, { locEnd: Qm } = Qu, {
          builders: {
            concat: Zm,
            line: eg,
        ...
        function cg(e) {
          return 'ObjectExpression' === e.type && (e.properties.length > 0 || e.comments) || 'ArrayExpression' === e.type && (e.elements.length > 0 || e.comments) || 'TSTypeAssertion' === e.type && cg(e.expression) || 'TSAsExpression' === e.type && cg(e.expression) || 'FunctionExpression' === e.type || 'ArrowFunctionExpression' === e.type && (!e.returnType || !e.returnType.typeAnnotation || 'TSTypeReference' !== e.returnType.typeAnnotation.type) && ('BlockStatement' === e.body.type || 'ArrowFunctionExpression' === e.body.type || 'ObjectExpression' === e.body.type || 'ArrayExpression' === e.body.type || 'CallExpression' === e.body.type || 'OptionalCallExpression' === e.body.type || 'ConditionalExpression' === e.body.type || Hm(e.body));
        }

        var lg = function(e, t, n) {
          const r = e.getValue(), o = 'ImportExpression' === r.type, u = Ym(r);
          ...
          Km(e, ((e, r) => {
            ...
            r === c || (Vm(t.originalText, o, Qm) ? (0 === r && (s = !0), i = !0, u.push(',', tg, tg)) : u.push(',', eg)), a = function(e, t) {
              if (!e || 'ArrowFunctionExpression' !== e.type || !e.body || 'BlockStatement' !== e.body.type || 0 === $m(e).length) return !1;
              let r = !1;
              return Wm(t, (e => {
                r = r || sg(Zm([n(e)]));
              })), r;
          ...
          function d() {
            return rg(Zm(['(', og(Zm([eg, Zm(l)])), p, eg, ')']), { shouldBreak: !0 });
          }
          ...
          const f = function(e) {
            ...
            const [t, n] = e;
            return !(t.comments && t.comments.length || 'FunctionExpression' !== t.type && ('ArrowFunctionExpression' !== t.type || 'BlockStatement' !== t.body.type) || 'FunctionExpression' === n.type || 'ArrowFunctionExpression' === n.type || 'ConditionalExpression' === n.type || cg(n));
          }(u), h = function(e) {
            const t = Rm(e), n = qm(e);
          ...
          if (f || h) {
            ...
            let o = [];
            Km(e, ((e, t) => {
              f && 0 === t && (o = [Zm([e.call((e => n(e, { expandFirstArg: !0 }))), l.length > 1 ? ',' : '', s ? tg : eg, s ? tg : ''])].concat(l.slice(1))), h && t === u.length - 1 && (o = l.slice(0, -1).concat(e.call((e => n(e, { expandLastArg: !0 })))));
            }));
            const c = l.some(sg), p = Zm(['(', Zm(o), ')']);
        ...
        } = cn, { isNumericLiteral: mg } = yc, { printOptionalToken: gg } = Vp;

        function Dg(e, t, n) {
          const r = e.call(n, 'property'), o = e.getValue(), u = gg(e);
        ...
        const {
          getLast: Eg,
          isNextLineEmpty: Cg,
          isNextLineEmptyAfterIndex: bg,
          getNextNonSpaceNonCommentCharacterIndex: vg
        } = Lt, {
          hasLeadingComment: Ag,
          hasTrailingComment: Fg,
          isCallOrOptionalCallExpression: xg,
          isFunctionOrArrowExpression: Sg,
          isLongCurriedCallExpression: wg,
          isMemberish: Tg,
          isNumericLiteral: Bg,
          isSimpleCallArgument: kg
        } = yc, { locEnd: Ng } = Qu, {
          builders: {
            concat: Pg,
            join: Og,
        ...
        } = cn, { printMemberLookup: qg } = yg, {
          printOptionalToken: Vg,
          printFunctionTypeParameters: $g,
          printBindExpressionCallee: Wg
        } = Vp;
        var Ug = function(e, t, n) {
          const r = e.getParentNode(), o = !r || 'ExpressionStatement' === r.type, u = [];

          function i(e) {
            const { originalText: n } = t, r = vg(n, e, Ng);
            return ')' === n.charAt(r) ? !1 !== r && bg(n, r + 1) : Cg(n, e, Ng);
          }

          function a(e) {
            const r = e.getValue();
            xg(r) && (Tg(r.callee) || xg(r.callee)) ? (u.unshift({
              node: r,
              printed: Pg([ma.printComments(e, (() => Pg([Vg(e), $g(e, t, n), lg(e, t, n)])), t), i(r) ? _g : ''])
            }), e.call((e => a(e)), 'callee')) : Tg(r) ? (u.unshift({
              node: r,
              needsParens: Fp(e, t),
              printed: ma.printComments(e, (() => 'OptionalMemberExpression' === r.type || 'MemberExpression' === r.type ? qg(e, t, n) : Wg(e, t, n)), t)
            }), e.call((e => a(e)), 'object')) : 'TSNonNullExpression' === r.type ? (u.unshift({
              node: r,
              printed: ma.printComments(e, (() => '!'), t)
            }), e.call((e => a(e)), 'expression')) : u.unshift({ node: r, printed: e.call(n) });
          }

          const s = e.getValue();
          u.unshift({
            node: s,
            printed: Pg([Vg(e), $g(e, t, n), lg(e, t, n)])
          ...
          if (!xg(u[0].node)) for (; p + 1 < u.length && Tg(u[p].node) && Tg(u[p + 1].node); ++p) l.push(u[p]);
          c.push(l), l = [];
          let d = !1;
          for (; p < u.length; ++p) {
            if (d && Tg(u[p].node)) {
              if (u[p].node.computed && Bg(u[p].node.property)) {
                l.push(u[p]);
                continue;
              }
              c.push(l), l = [], d = !1;
          ...
          function m(e) {
            ...
            return e.length > 0 && e[e.length - 1].needsParens ? Pg(['(', ...t, ')']) : Pg(t);
          }

          const g = c.map(m), D = Pg(g), y = h ? 3 : 2, E = $u(c),
            C = E.slice(1, -1).some((e => Ag(e.node))) || E.slice(0, -1).some((e => Fg(e.node))) || c[y] && Ag(c[y][0].node);
          if (c.length <= y && !C) return wg(e) ? D : Lg(D);
          const b = Eg(c[h ? 1 : 0]).node, v = !xg(b) && i(b),
            A = Pg([m(c[0]), h ? Pg(c.slice(1, 2).map(m)) : '', v ? _g : '', function(e) {
              return 0 === e.length ? '' : Ig(Lg(Pg([_g, Og(_g, e.map(m))])));
            }(c.slice(h ? 2 : 1))]), F = u.map((({ node: e }) => e)).filter(xg);
          return C || F.length > 2 && F.some((e => !e.arguments.every((e => kg(e, 0))))) || g.slice(0, -1).some(Rg) || function() {
            const e = Eg(Eg(c)).node, t = Eg(g);
            return xg(e) && Rg(t) && F.slice(0, -1).some((e => e.arguments.some(Sg)));
          }() ? Lg(A) : Pg([Rg(D) || v ? jg : '', Mg([D, A])]);
        };
        const { builders: { concat: Jg, join: zg, group: Hg } } = cn, {
          getCallArguments: Gg,
          hasFlowAnnotationComment: Xg,
          isCallOrOptionalCallExpression: Yg,
          isMemberish: Kg,
          isTemplateOnItsOwnLine: Qg,
          isTestCall: Zg,
          iterateCallArgumentsPath: eD
        } = yc, { printOptionalToken: tD, printFunctionTypeParameters: nD } = Vp;
        var rD = {
          printCallExpression: function(e, t, n) {
            const r = e.getValue(), o = 'NewExpression' === r.type, u = 'ImportExpression' === r.type, i = tD(e),
              a = Gg(r);
            if (a.length > 0 && (!u && !o && 'Identifier' === r.callee.type && ('require' === r.callee.name || 'define' === r.callee.name) || 1 === a.length && Qg(a[0], t.originalText) || !o && Zg(r, e.getParentNode()))) {
              const r = [];
              return eD(e, (e => {
                r.push(n(e));
              })), Jg([o ? 'new ' : '', e.call(n, 'callee'), i, nD(e, t, n), Jg(['(', zg(', ', r), ')'])]);
            }
        ...
        const {
          ...
          hasTrailingComment: lD,
          hasTrailingLineComment: pD,
          identity: dD
        } = yc, { getTypeParametersGroupId: fD } = _h, { printTypeScriptModifiers: hD } = Vp;
        var mD = {
        ...
        const { printComments: gD } = ma, { getLast: DD } = Lt, {
          builders: {
            concat: yD,
            join: ED,
            line: CD,
            ...
            align: FD,
            ifBreak: xD
          }, utils: { normalizeParts: SD }
        } = cn, {
          hasLeadingOwnLineComment: wD,
          hasTrailingLineComment: TD,
          isBinaryish: BD,
          isJSXNode: kD,
          shouldFlatten: ND
        } = yc;
        ...
        function _D(e) {
          return 'LogicalExpression' === e.type && ('ObjectExpression' === e.right.type && 0 !== e.right.properties.length || 'ArrayExpression' === e.right.type && 0 !== e.right.elements.length || !!kD(e.right));
        }

        var LD = {
          printBinaryishExpression: function(e, t, n) {
            const r = e.getValue(), o = e.getParentNode(), u = e.getParentNode(1),
            ...
            const p = kD(r.right), d = a.findIndex((e => 'string' != typeof e && 'group' === e.type)),
              f = a.slice(0, -1 === d ? 1 : d + 1), h = yD(a.slice(f.length, p ? -1 : void 0)),
              m = Symbol('logicalChain-' + ++PD), g = vD(yD([...f, AD(h)]), { id: m });
            if (!p) return g;
            const D = DD(a);
            return vD(yD([g, xD(AD(D), D, { groupId: m })]));
          }, shouldInlineLogicalExpression: _D
        };
        const { builders: { concat: ID, line: MD, group: jD, indent: RD } } = cn, {
          hasLeadingOwnLineComment: qD,
          isBinaryish: VD,
          isMemberExpressionChain: $D,
          isStringLiteral: WD
        } = yc, { shouldInlineLogicalExpression: UD } = LD;

        function JD(e, t, n, r, o, u) {
          if (!r) return t;
          const i = zD(e, r, o, u);
          return jD(ID([t, n, i]));
        }
        ...
        function zD(e, t, n, r) {
          return qD(r.originalText, t) ? RD(ID([MD, n])) : VD(t) && !UD(t) || 'ConditionalExpression' === t.type && VD(t.test) && !UD(t.test) || 'StringLiteralTypeAnnotation' === t.type || 'ClassExpression' === t.type && t.decorators && t.decorators.length || ('Identifier' === e.type || WD(e) || 'MemberExpression' === e.type) && (WD(t) || $D(t)) && 'json' !== r.parser && 'json5' !== r.parser || 'SequenceExpression' === t.type ? jD(RD(ID([MD, n]))) : ID([' ', n]);
        }

        var HD = {
          printVariableDeclarator: function(e, t, n) {
            const r = e.getValue();
            return JD(r.id, e.call(n, 'id'), ' =', r.init, r.init && e.call(n, 'init'), t);
          }, printAssignmentExpression: function(e, t, n) {
            const r = e.getValue();
            return JD(r.left, e.call(n, 'left'), ID([' ', r.operator]), r.right, e.call(n, 'right'), t);
          }, printAssignment: JD, printAssignmentRight: zD
        };
        const { isNextLineEmpty: GD } = Lt, {
          builders: {
            concat: XD,
            join: YD,
            hardline: KD
          ...
          classChildNeedsASIProtection: QD,
          classPropMayCauseASIProblems: ZD,
          getLeftSidePathName: ey,
          hasNakedLeftSide: ty,
          isJSXNode: ny,
          isLastStatement: ry,
          isTheOnlyJSXElementInMarkdown: oy
        } = yc, { locEnd: uy } = Qu, { shouldPrintParamsWithoutParens: iy } = Em;
        ...
        function ay({ path: e, index: t, bodyNode: n, isClass: r }, o, u) {
          ...
          if (o.semi || r || oy(o, e) || !function(e, t) {
            return 'ExpressionStatement' === e.getNode().type && e.call((e => sy(e, t)), 'expression');
          }(e, o) ? c.push(a) : i.comments && i.comments.some((e => e.leading)) ? c.push(u(e, { needsSemi: !0 })) : c.push(';', a), !o.semi && r) if (ZD(e)) c.push(';'); else if ('ClassProperty' === i.type || 'FieldDefinition' === i.type) {
            const e = n.body[t + 1];
            QD(e) && c.push(';');
          }
        ...
        function sy(e, t) {
          const n = e.getValue();
          return !!(Fp(e, t) || 'ParenthesizedExpression' === n.type || 'TypeCastExpression' === n.type || 'ArrowFunctionExpression' === n.type && !iy(e, t) || 'ArrayExpression' === n.type || 'ArrayPattern' === n.type || 'UnaryExpression' === n.type && n.prefix && ('+' === n.operator || '-' === n.operator) || 'TemplateLiteral' === n.type || 'TemplateElement' === n.type || ny(n) || 'BindExpression' === n.type && !n.object || 'RegExpLiteral' === n.type || 'Literal' === n.type && n.pattern || 'Literal' === n.type && n.regex) || !!ty(n) && e.call((e => sy(e, t)), ...ey(e, n));
        }

        var cy = {
          printStatementSequence: function(e, t, n) {
            const r = e.getNode(), o = 'ClassBody' === r.type,
              u = e.map(((u, i) => ay({ path: e, index: i, bodyNode: r, isClass: o }, t, n))).filter(Boolean);
            return YD(KD, u);
          }
        };
        const { printDanglingComments: ly } = ma, { isNextLineEmpty: py } = Lt, {
          builders: {
            concat: dy,
            hardline: fy,
            indent: hy
          }
        } = cn, { hasDanglingComments: my } = yc, { locEnd: gy } = Qu, { printStatementSequence: Dy } = cy;
        var yy = {
          printBlock: function(e, t, n) {
            const r = e.getValue(), o = [], u = t.semi ? ';' : '', i = e.call((e => Dy(e, t, n)), 'body');
            'StaticBlock' === r.type && o.push('static ');
            const a = r.body.some((e => 'EmptyStatement' !== e.type)), s = r.directives && r.directives.length > 0,
              c = e.getParentNode(), l = e.getParentNode(1);
            return a || s || my(r) || 'ArrowFunctionExpression' !== c.type && 'FunctionExpression' !== c.type && 'FunctionDeclaration' !== c.type && 'ObjectMethod' !== c.type && 'ClassMethod' !== c.type && 'ClassPrivateMethod' !== c.type && 'ForStatement' !== c.type && 'WhileStatement' !== c.type && 'DoWhileStatement' !== c.type && 'DoExpression' !== c.type && ('CatchClause' !== c.type || l.finalizer) && 'TSModuleDeclaration' !== c.type && 'TSDeclareFunction' !== c.type && 'StaticBlock' !== r.type ? (o.push('{'), s && e.each((e => {
              o.push(hy(dy([fy, n(e), u]))), py(t.originalText, e.getValue(), gy) && o.push(fy);
            }), 'directives'), a && o.push(hy(dy([fy, i]))), o.push(ly(e, t)), o.push(fy, '}'), dy(o)) : dy([...o, '{}']);
          }
        };
        const { hasNewline: Ey } = Lt, { builders: { concat: Cy, join: by, hardline: vy } } = cn, {
          isLineComment: Ay,
          isBlockComment: Fy
        } = yc, { locStart: xy, locEnd: Sy } = Qu;
        var wy = {
            ...
            if (Fy(n)) {
              if (function(e) {
                ...
                const e = function(e) {
                  ...
                  return Cy(['/*', by(vy, t.map(((e, n) => 0 === n ? e.trimEnd() : ' ' + (n < t.length - 1 ? e.trim() : e.trimStart())))), '*/']);
                }(n);
                return n.trailing && !Ey(t.originalText, xy(n), { backwards: !0 }) ? Cy([vy, e]) : e;
              }
              const e = Sy(n), r = '*-/' === t.originalText.slice(e - 3, e);
              return '/*' + n.value + (r ? '*-/' : '*/');
            }
        ...
        } = cn, { insertPragma: zy } = pp, {
          printHtmlBinding: Hy,
          isVueEventBindingExpression: Gy
        } = Np, {
          getFunctionParameters: Xy,
          getCallArguments: Yy,
          getParentExportDeclaration: Ky,
          getTypeScriptMappedTypeModifier: Qy,
          hasDanglingComments: Zy,
          hasFlowShorthandAnnotationComment: eE,
          hasLeadingOwnLineComment: tE,
          hasNewlineBetweenOrAfterDecorators: nE,
          hasNgSideEffect: rE,
          hasPrettierIgnore: oE,
          hasTrailingComment: uE,
          isExportDeclaration: iE,
          isFunctionNotation: aE,
          isGetterOrSetter: sE,
          isLiteral: cE,
          isNgForOf: lE,
          isObjectType: pE,
          isObjectTypePropertyAFunction: dE,
          isTheOnlyJSXElementInMarkdown: fE,
          isTSXFile: hE,
          isBlockComment: mE,
          needsHardlineAfterDanglingComment: gE,
          rawText: DE,
          shouldPrintComma: yE
        } = yc, { locStart: EE, locEnd: CE } = Qu, {
          printOptionalToken: bE,
          printBindExpressionCallee: vE,
          printTypeScriptModifiers: AE,
          printDecorators: FE,
          printFlowDeclaration: xE,
          adjustClause: SE
        } = Vp, {
          printImportDeclaration: wE,
          printExportDeclaration: TE,
          printExportAllDeclaration: BE,
          printModuleSpecifier: kE
        } = id, { printFunctionParameters: NE } = Jd, { printTemplateLiteral: PE } = ml, {
          printArray: OE,
          printArrayItems: _E
        } = ff, { printObject: LE } = If, { printTypeAnnotation: IE, shouldHugType: ME } = Yd, {
          printJsxElement: jE,
          printJsxAttribute: RE,
          printJsxOpeningElement: qE,
          printJsxClosingElement: VE,
          printJsxOpeningClosingFragment: $E,
          printJsxExpressionContainer: WE,
          printJsxEmptyExpression: UE,
          printJsxSpreadAttribute: JE,
          printJsxSpreadChild: zE
        } = gh, {
          printClass: HE,
          printClassMethod: GE
        } = jm, { printTypeParameters: XE } = _h, { printPropertyKey: YE } = Jh, {
          printFunctionDeclaration: KE,
          printArrowFunctionExpression: QE,
          printMethod: ZE,
          printReturnAndThrowArgument: eC
        } = Em, { printCallExpression: tC } = rD, { printInterface: nC } = mD, {
          printVariableDeclarator: rC,
          printAssignmentExpression: oC,
          printAssignment: uC,
          printAssignmentRight: iC
        } = HD, { printBinaryishExpression: aC } = LD, { printStatementSequence: sC } = cy, { printMemberExpression: cC } = yg, { printBlock: lC } = yy, { printComment: pC } = wy;

        function dC(e, t, n) {
          const r = DE(e), o = n || 'DirectiveLiteral' === e.type;
          return Ny(r, t, o);
        }
        ...
        var hC = {
          ...
          print: function(e, t, n, r) {
              ...
              switch (o.type) {
                ...
                case'Program': {
                  ...
                  if (o.directives) {
                    ...
                    e.each(((e, o) => {
                      a.push(n(e), u, My), (o < i - 1 || r) && Oy(t.originalText, e.getValue(), CE) && a.push(My);
                    }), 'directives');
                  }
                  return a.push(e.call((e => sC(e, t, n)), 'body')), a.push(ma.printDanglingComments(e, t, !0)), r && a.push(My), _y(a);
                }
                case'EmptyStatement':
                  return '';
                case'ExpressionStatement':
                  ...
                  if ('__vue_event_binding' === t.parser) {
                    const t = e.getParentNode();
                    if ('Program' === t.type && 1 === t.body.length && t.body[0] === o) return _y([e.call(n, 'expression'), Gy(o.expression) ? ';' : '']);
                  }
                ...
                case'AwaitExpression': {
                  ...
                  const t = e.getParentNode();
                  return ('CallExpression' === t.type || 'OptionalCallExpression' === t.type) && t.callee === o || ('MemberExpression' === t.type || 'OptionalMemberExpression' === t.type) && t.object === o ? qy(_y([Vy(_y([jy, _y(a)])), jy])) : _y(a);
                }
                ...
                case'SequenceExpression': {
                  ...
                  if ('ExpressionStatement' === t.type || 'ForStatement' === t.type) {
                    const t = [];
                    return e.each((e => {
                      0 === e.getName() ? t.push(n(e)) : t.push(',', Vy(_y([Iy, n(e)])));
                    }), 'expressions'), qy(_y(t));
                  }
                  return qy(_y([Ly(_y([',', Iy]), e.map(n, 'expressions'))]));
                }
                case'ThisExpression':
                  return 'this';
                case'Super':
                ...
                case'VariableDeclaration': {
                  const t = e.map((e => n(e)), 'declarations'), r = e.getParentNode(),
                    i = 'ForStatement' === r.type || 'ForInStatement' === r.type || 'ForOfStatement' === r.type,
                    s = o.declarations.some((e => e.init));
                  let c;
                  return 1 !== t.length || o.declarations[0].comments ? t.length > 0 && (c = Vy(t[0])) : c = t[0], a = [o.declare ? 'declare ' : '', o.kind, c ? _y([' ', c]) : '', Vy(_y(t.slice(1).map((e => _y([',', s && !i ? My : Iy, e])))))], i && r.body !== o || a.push(u), qy(_y(a));
                }
                case'TSTypeAliasDeclaration': {
                  o.declare && a.push('declare ');
                  const r = iC(o.id, o.typeAnnotation, o.typeAnnotation && e.call(n, 'typeAnnotation'), t);
                  return a.push('type ', e.call(n, 'id'), e.call(n, 'typeParameters'), ' =', r, u), qy(_y(a));
                }
                case'WithStatement':
                ...
                case'ForStatement': {
                  const r = SE(o.body, e.call(n, 'body')), u = ma.printDanglingComments(e, t, !0),
                    i = u ? _y([u, jy]) : '';
                ...
                case'DoWhileStatement': {
                  const t = SE(o.body, e.call(n, 'body')), r = qy(_y(['do', t]));
                  return a = [r], 'BlockStatement' === o.body.type ? a.push(' ') : a.push(My), a.push('while ('), a.push(qy(_y([Vy(_y([jy, e.call(n, 'test')])), jy])), ')', u), _y(a);
                }
                case'DoExpression':
                ...
                case'SwitchStatement':
                  return _y([qy(_y(['switch (', Vy(_y([jy, e.call(n, 'discriminant')])), jy, ')'])), ' {', o.cases.length > 0 ? Vy(_y([My, Ly(My, e.map((e => {
                    const r = e.getValue();
                    return _y([e.call(n), o.cases.indexOf(r) !== o.cases.length - 1 && Oy(t.originalText, r, CE) ? My : '']);
                  }), 'cases'))])) : '', My, '}']);
                case'SwitchCase': {
                ...
                case'TSFunctionType': {
                  ...
                  return dE(r) && (s = !0, c = !0), l && a.push('('), a.push(NE(e, n, t, !1, !0)), (o.returnType || o.predicate || o.typeAnnotation) && a.push(s ? ' => ' : ': ', e.call(n, 'returnType'), e.call(n, 'predicate'), e.call(n, 'typeAnnotation')), l && a.push(')'), qy(_y(a));
                }
                case'TSRestType':
                ...
                case'FunctionTypeParam': {
                  ...
                  return _y([t, bE(e), t ? ': ' : '', e.call(n, 'typeAnnotation')]);
                }
                ...
                case'UnionTypeAnnotation': {
                  const r = e.getParentNode(),
                    ...
                    i = ME(o), a = e.map((e => {
                      let r = e.call(n);
                      return i || (r = $y(2, r)), ma.printComments(e, (() => r), t);
                    }), 'types');
                  if (i) return Ly(' | ', a);
                  const s = u && !tE(t.originalText, o), c = _y([Uy(_y([s ? Iy : '', '| '])), Ly(_y([Iy, '| ']), a)]);
                ...
                case'Variance': {
                  const { kind: e } = o;
                  return zi.ok('plus' === e || 'minus' === e), 'plus' === e ? '+' : '-';
                }
                ...
                case'ObjectTypeProperty': {
                  let r = '';
                  return o.proto ? r = 'proto ' : o.static && (r = 'static '), _y([r, sE(o) ? o.kind + ' ' : '', o.variance ? e.call(n, 'variance') : '', YE(e, t, n), bE(e), aE(o) ? '' : ': ', e.call(n, 'value')]);
                }
                ...
                case'TypeParameterInstantiation': {
                  ...
                  if ('flow' === t.parser) {
                    const e = EE(o), n = CE(o), u = t.originalText.lastIndexOf('/*', e),
                      i = t.originalText.indexOf('*/', n);
                    if (-1 !== u && -1 !== i) {
                      const e = t.originalText.slice(u + 2, i).trim();
                      if (e.startsWith('::') && !e.includes('/*') && !e.includes('*/')) return _y(['/*:: ', r, ' */']);
                    }
                  }
                  return r;
                }
                ...
                case'TypeParameter': {
                  const r = e.getParentNode();
                  if ('TSMappedType' === r.type) return a.push('[', e.call(n, 'name')), o.constraint && a.push(' in ', e.call(n, 'constraint')), r.nameType && a.push(' as ', e.callParent((e => e.call(n, 'nameType')))), a.push(']'), _y(a);
                  ...
                  const u = e.getNode(2);
                  return 1 === Xy(r).length && hE(t) && !o.constraint && 'ArrowFunctionExpression' === u.type && a.push(','), _y(a);
                }
                ...
                case'TSIndexSignature': {
                  const r = e.getParentNode(), i = o.parameters.length > 1 ? Uy(yE(t) ? ',' : '') : '',
                ...
                case'TSMappedType': {
                  const r = By(t.originalText, EE(o), CE(o));
                  return qy(_y(['{', Vy(_y([t.bracketSpacing ? Iy : jy, o.readonly ? _y([Qy(o.readonly, 'readonly'), ' ']) : '', AE(e, t, n), e.call(n, 'typeParameter'), o.optional ? Qy(o.optional, '?') : '', o.typeAnnotation ? ': ' : '', e.call(n, 'typeAnnotation'), Uy(u, '')])), ma.printDanglingComments(e, t, !0), t.bracketSpacing ? Iy : jy, '}']), { shouldBreak: r });
                }
                ...
                case'TSModuleDeclaration': {
                  const r = e.getParentNode(), i = cE(o.id), s = 'TSModuleDeclaration' === r.type,
                    c = o.body && 'TSModuleDeclaration' === o.body.type;
                  if (s) a.push('.'); else {
                    o.declare && a.push('declare '), a.push(AE(e, t, n));
                    const r = t.originalText.slice(EE(o), EE(o.id));
                    'Identifier' === o.id.type && 'global' === o.id.name && !/namespace|module/.test(r) || a.push(i || /(^|\s)module(\s|$)/.test(r) ? 'module ' : 'namespace ');
                  }
                  return a.push(e.call(n, 'id')), c ? a.push(e.call(n, 'body')) : o.body ? a.push(' ', qy(e.call(n, 'body'))) : a.push(u), _y(a);
                }
                case'PrivateName':
                ...
                case'NGMicrosyntaxKeyedExpression': {
                  const t = e.getName(), r = e.getParentNode(),
            ...
            if (!o || Jy(i)) return i;
            const a = Ky(e), s = [];
            if ('ClassMethod' === o.type || 'ClassPrivateMethod' === o.type || 'ClassProperty' === o.type || 'FieldDefinition' === o.type || 'TSAbstractClassProperty' === o.type || 'ClassPrivateProperty' === o.type || 'MethodDefinition' === o.type || 'TSAbstractMethodDefinition' === o.type || 'TSDeclareMethod' === o.type) ; else if (o.decorators && o.decorators.length > 0 && !(a && EE(a, { ignoreDecorators: !0 }) > EE(o.decorators[0]))) {
          ...
          embed: function(e, t, n, r) {
            ...
            const u = function(e) {
              return function(e) {
                ...
                return e.match((e => 'TemplateLiteral' === e.type), ((e, t) => 'ArrayExpression' === e.type && 'elements' === t), ((e, t) => ('Property' === e.type || 'ObjectProperty' === e.type) && 'Identifier' === e.key.type && 'styles' === e.key.name && 'value' === t), ...Hl);
              }(e) ? 'css' : function(e) {
                const t = e.getValue(), n = e.getParentNode();
                ...
                return Yl(e.getValue(), 'HTML') || e.match((e => 'TemplateLiteral' === e.type), ((e, t) => 'TaggedTemplateExpression' === e.type && 'Identifier' === e.tag.type && 'html' === e.tag.name && 'quasi' === t));
              }(e) ? 'html' : function(e) {
                return e.match((e => 'TemplateLiteral' === e.type), ((e, t) => ('Property' === e.type || 'ObjectProperty' === e.type) && 'Identifier' === e.key.type && 'template' === e.key.name && 'value' === t), ...Hl);
            ...
            return u ? 'markdown' === u ? function(e, t, n) {
                  ...
                  const r = Sl(e, (e => {
                    ...
                    return r.forEach((e => {
                      'string' == typeof e && e.includes('@prettier-placeholder') ? e.split(/@prettier-placeholder-(\d+)-id/).forEach(((e, r) => {
                        r % 2 != 0 ? (i.push(t[e]), n++) : i.push(wl(e));
                      })) : i.push(e);
              ...
              let p = 0;
              const d = n(s, {
                  parser: o, __onHtmlRoot(e) {
                    p = e.children.length;
                  }
                }, { stripTrailingHardline: !0 }), f = Vl(d, (e => {
                  if ('string' != typeof e) return e;
                  const t = [], n = e.split(l);
                  for (let e = 0; e < n.length; e++) {
                    let o = n[e];
                    if (e % 2 == 0) {
                      o && (o = Wl(o), r.embeddedInHtml && (o = o.replace(/<\/(script)\b/gi, '<\\/$1')), t.push(o));
                      continue;
                    }
                    const u = +o;
                    t.push(c[u]);
          ...
          isBlockComment: mE,
          handleComments: {
            ownLine: Kc.handleOwnLineComment,
            endOfLine: Kc.handleEndOfLineComment,
            remaining: Kc.handleRemainingComment
          },
          getGapRegex: Kc.getGapRegex,
          getCommentChildNodes: Kc.getCommentChildNodes
        };
        const { builders: { concat: mC, hardline: gC, indent: DC, join: yC } } = cn,
          EC = new Set(['start', 'end', 'extra', 'loc', 'comments', 'errors', 'range']);
        ...
        var bC = {
          preprocess: Pp, print: function(e, t, n) {
            const r = e.getValue();
            switch (r.type) {
              case'JsonRoot':
        ...
        var xC = {
          ...
          bracketSpacing: AC.bracketSpacing,
          jsxBracketSameLine: {
            since: '0.17.0',
            category: FC,
            type: 'boolean',
          ...
          languages: [vs(SC, (e => ({
            ...
            codemirrorMimeType: 'application/json',
            languageId: 175
          }, (() => ({ since: '1.13.0', parsers: ['json5'], vscodeLanguageIds: ['json5'] })))],
          options: xC,
          printers: { estree: hC, 'estree-json': bC },
          parsers: {
            get babel() {
        ...
        const { isFrontMatterNode: BC } = Lt,
          kC = new Set(['raw', 'raws', 'sourceIndex', 'source', 'before', 'after', 'trailingComma']);

        function NC(e, t, n) {
          if (BC(e) && 'yaml' === e.lang && delete t.value, 'css-comment' === e.type && 'css-root' === n.type && 0 !== n.nodes.length) {
            if ((n.nodes[0] === e || BC(n.nodes[0]) && n.nodes[1] === e) && (delete t.text, /^\*\s*@(format|prettier)\s*$/.test(e.text))) return null;
        ...
        var $C = {
          hasPragma: function(e) {
            return pp.hasPragma(VC(e).content);
          }, insertPragma: function(e) {
            const { frontMatter: t, content: n } = VC(e);
            return (t ? t.raw + '\n\n' : '') + pp.insertPragma(n);
          }
        };
        ...
        function QC(e) {
          return 'value-paren_group' === e.type && e.groups && e.groups[0] && KC(e.groups[0]);
        }
        ...
        var ZC = {
          ...
          isMathOperatorNode: function(e) {
            return zC(e) || HC(e) || GC(e) || XC(e) || YC(e);
          },
          ...
          isSCSSMapItemNode: function(e) {
            ...
            if (!(QC(t) || n && QC(n))) return !1;
            const r = JC(e, 'css-decl');
            return !!(r && r.prop && r.prop.startsWith('$')) || !!QC(n) || 'value-func' === n.type;
          },
          ...
          isColorAdjusterFuncNode: function(e) {
            return 'value-func' === e.type && WC.has(e.value.toLowerCase());
          },
        ...
        function rb(e, t) {
          return 'number' == typeof e.sourceIndex ? e.sourceIndex : e.source ? eb(e.source.start, t) - 1 : null;
        }

        function ob(e, t) {
          if ('css-comment' === e.type && e.inline) return nb(t, e.source.startOffset);
          const n = e.nodes && tb(e.nodes);
          return n && e.source && !e.source.end && (e = n), e.source && e.source.end ? eb(e.source.end, t) : null;
        }

        function ub(e, t, n) {
          e.source && (e.source.startOffset = rb(e, n) + t, e.source.endOffset = ob(e, n) + t);
          for (const r in e) {
            const o = e[r];
            'source' !== r && o && 'object' == typeof o && ub(o, t, n);
          }
        }
        ...
        var ab = {
          locStart: function(e) {
            ...
            t.source && (t.source.startOffset = rb(t, n), t.source.endOffset = ob(t, n));
            for (const r in t) {
              const o = t[r];
              'source' !== r && o && 'object' == typeof o && ('value-root' === o.type || 'value-unknown' === o.type ? ub(o, ib(t), o.text || o.value) : e(o, n));
            }
        ...
        const {
          ...
          builders: {
            ...
            ifBreak: vb,
            breakParent: Ab
          }, utils: { removeLines: Fb }
        } = cn, { insertPragma: xb } = $C, {
          getAncestorNode: Sb,
          getPropOfDeclNode: wb,
          maybeToLowerCase: Tb,
          insideValueFunctionNode: Bb,
          insideICSSRuleNode: kb,
          insideAtRuleNode: Nb,
          insideURLFunctionInImportAtRuleNode: Pb,
          isKeyframeAtRuleKeywords: Ob,
          isWideKeywords: _b,
          isSCSS: Lb,
          isLastNode: Ib,
          isLessParser: Mb,
          isSCSSControlDirectiveNode: jb,
          isDetachedRulesetDeclarationNode: Rb,
          isRelationalOperatorNode: qb,
          isEqualityOperatorNode: Vb,
          isMultiplicationNode: $b,
          isDivisionNode: Wb,
          isAdditionNode: Ub,
          isSubtractionNode: Jb,
          isMathOperatorNode: zb,
          isEachKeywordNode: Hb,
          isForKeywordNode: Gb,
          isURLFunctionNode: Xb,
          isIfElseKeywordNode: Yb,
          hasComposesNode: Kb,
          hasParensAroundNode: Qb,
          hasEmptyRawBefore: Zb,
          isKeyValuePairNode: ev,
          isDetachedRulesetCallNode: tv,
          isTemplatePlaceholderNode: nv,
          isTemplatePropNode: rv,
          isPostcssSimpleVarNode: ov,
          isSCSSMapItemNode: uv,
          isInlineValueCommentNode: iv,
          isHashNode: av,
          isLeftCurlyBraceNode: sv,
          isRightCurlyBraceNode: cv,
          isWordNode: lv,
          isColonNode: pv,
          isMediaAndSupportsKeywords: dv,
          isColorAdjusterFuncNode: fv,
          lastLineHasInlineComment: hv,
          isAtWordPlaceholderNode: mv
        } = ZC, { locStart: gv, locEnd: Dv } = ab;
        ...
        function Fv(e) {
          return e.replace(bv, ((e, t, n, r, o) => !n && r ? xv(r) + Tb(o || '') : e));
        }

        function xv(e) {
          return sb(e).replace(/\.0(?=$|e)/, '');
        }
        ...
        var Sv = {
          print: function(e, t, n) {
            ...
            switch (r.type) {
              case'front-matter':
                return fb([r.raw, gb]);
              case'css-root': {
                const o = Ev(e, t, n), u = r.raws.after.trim();
                return fb([o, u ? ' '.concat(u) : '', o.parts.length ? gb : '']);
              }
              case'css-comment': {
                const e = r.inline || r.raws.inline, n = t.originalText.slice(gv(r), Dv(r));
              ...
              case'css-decl': {
                ...
                return !a && hv(i) && (s = Cb(fb([gb, bb(s)]))), fb([r.raws.before.replace(/[\s;]/g, ''), kb(e) ? r.prop : Tb(r.prop), i.startsWith('//') ? ' ' : '', i, r.extend ? '' : ' ', Mb(t) && r.extend && r.selector ? fb(['extend(', e.call(n, 'selector'), ')']) : '', s, r.raws.important ? r.raws.important.replace(/\s*!\s*important/i, ' !important') : r.important ? ' !important' : '', r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/i, ' !default') : r.scssDefault ? ' !default' : '', r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/i, ' !global') : r.scssGlobal ? ' !global' : '', r.nodes ? fb([' {', Cb(fb([Db, Ev(e, t, n)])), Db, '}']) : rv(r) && !o.raws.semicolon && ';' !== t.originalText[Dv(r) - 1] ? '' : t.__isHTMLStyleAttribute && Ib(e, r) ? vb(';', '') : ';']);
              }
              case'css-atrule': {
                const o = e.getParentNode(), u = nv(r) && !o.raws.semicolon && ';' !== t.originalText[Dv(r) - 1];
                if (Mb(t)) {
                  if (r.mixin) return fb([e.call(n, 'selector'), r.important ? ' !important' : '', u ? '' : ';']);
                  if (r.function) return fb([r.name, fb([e.call(n, 'params')]), u ? '' : ';']);
                  if (r.variable) return fb(['@', r.name, ': ', r.value ? fb([e.call(n, 'value')]) : '', r.raws.between.trim() ? r.raws.between.trim() + ' ' : '', r.nodes ? fb(['{', Cb(fb([r.nodes.length > 0 ? Db : '', Ev(e, t, n)])), Db, '}']) : '', u ? '' : ';']);
                }
              ...
              case'selector-combinator': {
                if ('+' === r.value || '>' === r.value || '~' === r.value || '>>>' === r.value) {
                  const t = e.getParentNode(), n = 'selector-selector' === t.type && t.nodes[0] === r ? '' : mb;
                  return fb([n, r.value, Ib(e, r) ? '' : ' ']);
                }
                const n = r.value.trim().startsWith('(') ? mb : '', o = Fv(vv(r.value.trim(), t)) || mb;
                return fb([n, o]);
              }
              ...
              case'selector-unknown': {
                ...
                if (o.raws && o.raws.selector) {
                  const e = gv(o), n = e + o.raws.selector.length;
                ...
                if ('value-paren_group' === o.type && u && 'value-func' === u.type && 'selector' === u.value) {
                  const e = gv(o.open) + 1, n = Dv(o.close) - 1, r = t.originalText.slice(e, n).trim();
              ...
              case'value-comma_group': {
                const t = e.getParentNode(), o = e.getParentNode(1), u = wb(e),
                  i = u && 'value-value' === t.type && ('grid' === u || u.startsWith('grid-template')),
                  a = Sb(e, 'css-atrule'), s = a && jb(a), c = e.map(n, 'groups'), l = [], p = Bb(e, 'url');
                let d = !1, f = !1;
                for (let n = 0; n < r.groups.length; ++n) {
                  ...
                  if ($b(m) || $b(h) || Bb(e, 'calc') || b || !(Wb(m) && !v || Wb(h) && !A || Ub(m) && !v || Ub(h) && !A || Jb(m) || Jb(h)) || !(Zb(m) || E && (!u || u && zb(u)))) if (iv(h)) {
                ...
                return f && l.unshift(gb), s ? yb(Cb(fb(l))) : Pb(e) ? yb(Eb(l)) : yb(Cb(Eb(l)));
              }
              case'value-paren_group': {
                ...
                const u = uv(e), i = r.groups[r.groups.length - 1], a = i && 'value-comment' === i.type;
          ...
          }, insertPragma: xb, massageAstNode: PC
        }, wv = { singleQuote: AC.singleQuote }, Tv = {
          languages: [vs({
            name: 'CSS',
            type: 'markup',
            tmScope: 'source.css',
          ...
          }, (() => ({ since: '1.4.0', parsers: ['css'], vscodeLanguageIds: ['postcss'] }))), vs({
            name: 'Less',
            type: 'markup',
            color: '#1d365d',
            extensions: ['.less'],
            ...
            codemirrorMimeType: 'text/css',
            languageId: 198
          }, (() => ({ since: '1.4.0', parsers: ['less'], vscodeLanguageIds: ['less'] }))), vs({
            name: 'SCSS',
            type: 'markup',
            color: '#c6538c',
            ...
            extensions: ['.scss'],
            languageId: 329
          }, (() => ({ since: '1.4.0', parsers: ['scss'], vscodeLanguageIds: ['scss'] })))],
          options: wv,
          printers: { postcss: Sv },
          parsers: {
            get css() {
        ...
        function Pv(e) {
          return Ov(e, ['TextNode']) && !/\S/.test(e.chars);
        }
        ...
        function _v(e, t) {
          const n = e.getValue(), r = e.getParentNode(0) || {}, o = r.children || r.body || r.parts || [],
            u = o.indexOf(n);
          return -1 !== u && o[u + t];
        }
        ...
        function Mv(e) {
          return Ov(e, ['MustacheCommentStatement']) && 'string' == typeof e.value && 'prettier-ignore' === e.value.trim();
        }

        var jv = {
          getNextNode: Iv, getPreviousNode: Lv, hasPrettierIgnore: function(e) {
            const t = e.getValue(), n = Lv(e, 2);
            return Mv(t) || Mv(n);
          }, isNextNodeOfSomeType: function(e, t) {
            return Ov(Iv(e), t);
          }, isNodeOfSomeType: Ov, isParentOfSomeType: function(e, t) {
            return Ov(e.getParentNode(0), t);
          }, isPreviousNodeOfSomeType: function(e, t) {
            return Ov(Lv(e), t);
          }, isVoid: function(e) {
            return function(e) {
              return Ov(e, ['ElementNode']) && 'string' == typeof e.tag && (function(e) {
                return e.toUpperCase() === e;
              }(e.tag[0]) || e.tag.includes('.'));
            }(e) && e.children.every((e => Pv(e))) || Nv.has(e.tag);
          }, isWhitespaceNode: Pv
        };
        const {
          builders: {
          ...
          getNextNode: Xv,
          getPreviousNode: Yv,
          hasPrettierIgnore: Kv,
          isNextNodeOfSomeType: Qv,
          isNodeOfSomeType: Zv,
          isParentOfSomeType: eA,
          isPreviousNodeOfSomeType: tA,
          isVoid: nA,
          isWhitespaceNode: rA
        } = jv;
        ...
        function oA(e, t) {
          const n = e.getValue();
          return Rv(['<', n.tag, uA(e, t), NA(n), aA(n)]);
        }

        function uA(e, t) {
          const n = e.getValue();
          return Wv(Rv([n.attributes.length ? Jv : '', Uv(Jv, e.map(t, 'attributes')), n.modifiers.length ? Jv : '', Uv(Jv, e.map(t, 'modifiers')), n.comments.length ? Jv : '', Uv(Jv, e.map(t, 'comments'))]));
        }

        function iA(e, t, n) {
          return Rv(e.map(((e, r) => 0 === r ? Rv([zv, n(e, t, n)]) : n(e, t, n)), 'children'));
        }

        function aA(e) {
          return nA(e) ? $v(Rv([zv, '/>']), Rv([' />', zv])) : $v(Rv([zv, '>']), '>');
        }
        ...
        function lA(e) {
          const t = sA(e), n = e.openStrip.open ? '~' : '';
          return Rv([t, n, '#']);
        }

        function pA(e) {
          const t = cA(e), n = e.openStrip.close ? '~' : '';
          return Rv([n, t]);
        }

        function dA(e) {
          const t = sA(e), n = e.closeStrip.open ? '~' : '';
          return Rv([t, n, '/']);
        }

        function fA(e) {
          const t = cA(e), n = e.closeStrip.close ? '~' : '';
          return Rv([n, t]);
        }

        function hA(e) {
          const t = sA(e), n = e.inverseStrip.open ? '~' : '';
          return Rv([t, n]);
        }

        function mA(e) {
          const t = cA(e), n = e.inverseStrip.close ? '~' : '';
          return Rv([n, t]);
        }

        function gA(e, t) {
          const n = e.getValue();
          return qv(Rv([lA(n), TA(e, t), NA(n.program), zv, pA(n)]));
        }

        function DA(e) {
          return Rv([Vv, hA(e), 'else', mA(e)]);
        }

        function yA(e, t) {
          const n = e.getParentNode(1);
          return Rv([hA(n), 'else ', TA(e, t), mA(n)]);
        }

        function EA(e, t) {
          const n = e.getValue();
          return Rv([CA(n) ? zv : Vv, dA(n), e.call(t, 'path'), fA(n)]);
        }

        function CA(e) {
          return Zv(e, ['BlockStatement']) && e.program.body.every((e => rA(e)));
        }

        function bA(e) {
          return Zv(e, ['BlockStatement']) && e.inverse;
        }

        function vA(e, t) {
          if (CA(e.getValue())) return '';
          const n = e.call(t, 'program');
          return Wv(Rv([Vv, n]));
        }

        function AA(e, t) {
          const n = e.getValue(), r = e.call(t, 'inverse'), o = Rv([Vv, r]);
          return function(e) {
            return bA(e) && 1 === e.inverse.body.length && Zv(e.inverse.body[0], ['BlockStatement']) && 'if' === e.inverse.body[0].path.parts[0];
          }(n) ? o : bA(n) ? Rv([DA(n), Wv(o)]) : '';
        }
        ...
        function xA(e = 0, t = 0) {
          return new Array(Math.min(e, t)).fill(Vv);
        }

        function SA(e, t) {
          const n = { quote: '"', regex: /"/g }, r = { quote: '\'', regex: /'/g }, o = t.singleQuote ? r : n,
            u = o === r ? n : r;
          let i = !1;
        ...
        function NA(e) {
          return e && e.blockParams.length ? Rv([' as |', e.blockParams.join(' '), '|']) : '';
        }
        ...
        var PA = {
          print: function(e, t, n) {
            ...
            switch (r.type) {
              ...
              case'ElementNode': {
                const o = Qv(e, ['ElementNode']) ? Vv : '';
                if (nA(r)) return Rv([qv(oA(e, n)), o]);
                const u = r.children.every((e => rA(e)));
                return Rv([qv(oA(e, n)), qv(Rv([u ? '' : Wv(iA(e, t, n)), r.children.length ? Vv : '', Rv(['</', r.tag, '>'])])), o]);
              }
              case'BlockStatement': {
                const t = e.getParentNode(1),
              ...
              case'MustacheStatement': {
                const t = eA(e, ['AttrNode', 'ConcatStatement']),
                  o = eA(e, ['ElementNode']) && 0 === r.hash.pairs.length && function(e) {
              ...
              case'AttrNode': {
                ...
                const u = e.call(n, 'value'), i = o ? SA(u.parts.join(), t) : u;
                return Rv([r.name, '=', i]);
              }
              case'ConcatStatement': {
                const r = t.singleQuote ? '\'' : '"';
                return Rv([r, ...e.map((e => n(e)), 'parts'), r]);
              }
              case'Hash':
              ...
              case'TextNode': {
                const t = 2, n = !Yv(e), o = !Xv(e), u = !/\S/.test(r.chars), i = FA(r.chars);
                let a = function(e) {
                  return FA(((e = 'string' == typeof e ? e : '').match(/^([^\S\n\r]*[\n\r])+/g) || [])[0] || '');
                }(r.chars), s = function(e) {
                  return FA(((e = 'string' == typeof e ? e : '').match(/([\n\r][^\S\n\r]*)+$/g) || [])[0] || '');
                }(r.chars);
                ...
                if (u && i ? (a = Math.min(i, t), s = 0) : (Qv(e, ['BlockStatement', 'ElementNode']) && (s = Math.max(s, 1)), tA(e, ['BlockStatement', 'ElementNode']) && (a = Math.max(a, 1))), e.stack.includes('attributes')) {
                  if (!function(e, t) {
                    return eA(e, ['AttrNode']) && e.getParentNode().name.toLowerCase() === t || eA(e, ['ConcatStatement']) && e.getParentNode(1).name.toLowerCase() === t;
                  }(e, 'class')) return Rv([r.chars]);
                  let n = '', o = '';
                ...
                let c = '', l = '';
                0 === s && Qv(e, ['MustacheStatement']) && (l = ' '), 0 === a && tA(e, ['MustacheStatement']) && (c = ' '), n && (a = 0, c = ''), o && (s = 0, l = '');
                let p = r.chars;
                return p.startsWith('{{') && p.includes('}}') && (p = '\\' + p), Rv([...xA(a, t), p.replace(/^\s+/g, c).replace(/\s+$/, l), ...xA(s, t)]);
              }
              case'MustacheCommentStatement': {
                const e = r.value.includes('}}') ? '--' : '';
                return Rv(['{{!', e, r.value, e, '}}']);
              }
              case'PathExpression':
                return r.original;
              case'BooleanLiteral':
        ...
        } = cn, { isNextLineEmpty: $A } = Lt, { insertPragma: WA } = {
          hasPragma: function(e) {
            return /^\s*#[^\S\n]*@(format|prettier)\s*(\n|$)/.test(e);
          }, insertPragma: function(e) {
            return '# @format\n\n' + e;
          }
        }, { locStart: UA, locEnd: JA } = {
          locStart: function(e) {
        ...
        function zA(e, t, n) {
          ...
          const r = LA(MA, e.map(t, 'directives'));
          return 'FragmentDefinition' === n.kind || 'OperationDefinition' === n.kind ? RA(_A([MA, r])) : _A([' ', RA(qA(_A([jA, r])))]);
        }
        ...
        function HA(e, t, n) {
          ...
          return e.map(((e, o) => {
            const u = n(e);
            return $A(t.originalText, e.getValue(), JA) && o < r - 1 ? _A([u, IA]) : u;
          }));
        }
        ...
        var YA = {
          print: function(e, t, n) {
            ...
            switch (r.kind) {
              case'Document': {
                const o = [];
                return e.each(((e, u) => {
                  o.push(_A([e.call(n)])), u !== r.definitions.length - 1 && (o.push(IA), $A(t.originalText, e.getValue(), JA) && o.push(IA));
                }), 'definitions'), _A([_A(o), IA]);
              }
              case'OperationDefinition': {
                const o = '{' !== t.originalText[UA(r)], u = !!r.name;
          ...
          }, massageAstNode: XA, hasPrettierIgnore: function(e) {
            const t = e.getValue();
            return t && Array.isArray(t.comments) && t.comments.some((e => 'prettier-ignore' === e.value.trim()));
          }, insertPragma: WA, printComment: function(e) {
            const t = e.getValue();
        ...
        }, KA = { bracketSpacing: AC.bracketSpacing }, QA = {
          languages: [vs({
            name: 'GraphQL',
            type: 'data',
            color: '#e10098',
        ...
        const { getLast: eF } = Lt, { locStart: tF, locEnd: nF } = ZA, {
            cjkPattern: rF,
            kPattern: oF,
          ...
          aF = iF.concat(['tableCell', 'paragraph', 'heading']), sF = new RegExp(oF), cF = new RegExp(uF);
        ...
        var pF = {
          mapAst: function(e, t) {
            ...
            return ('preserve' === t.proseWrap ? e : e.replace(new RegExp('('.concat(rF, ')\n(').concat(rF, ')'), 'g'), '$1$2')).split(/([\t\n ]+)/).forEach(((e, t, a) => {
              t % 2 != 1 ? (0 !== t && t !== a.length - 1 || '' !== e) && e.split(new RegExp('('.concat(rF, ')'))).forEach(((e, t, u) => {
                (0 !== t && t !== u.length - 1 || '' !== e) && (t % 2 != 0 ? i(cF.test(e) ? {
                  type: 'word',
                  value: e,
                  kind: o,
                  ...
                  value: e,
                  kind: n,
                  hasLeadingPunctuation: cF.test(e[0]),
                  hasTrailingPunctuation: cF.test(eF(e))
                }));
          ...
          }, punctuationPattern: uF, getFencedCodeBlockValue: function(e, t) {
            const { value: n } = e;
            return e.position.end.offset === t.length && n.endsWith('\n') && t.endsWith('\n') ? n.slice(0, -1) : n;
          }, getOrderedListItemInfo: lF, hasGitDiffFriendlyOrderedList: function(e, t) {
            ...
            if (0 === n && e.children.length > 2) {
              const n = Number(lF(e.children[2], t.originalText).numberText);
              return 1 === r && 1 === n;
            }
            return 1 === r;
          }, INLINE_NODE_TYPES: iF, INLINE_NODE_WRAPPER_TYPES: aF, isAutolink: function(e) {
            if (!e || 'link' !== e.type || 1 !== e.children.length) return !1;
            const t = e.children[0];
            return t && tF(e) === tF(t) && nF(e) === nF(t);
          }
        };
        const { inferParserByLanguage: dF, getMaxContinuousCount: fF } = Lt, {
          builders: {
            hardline: hF,
            concat: mF,
            markAsRoot: gF
          }, utils: { replaceNewlinesWithLiterallines: DF }
        } = cn, { print: yF } = MC, { getFencedCodeBlockValue: EF } = pF;
        ...
        var AF = {
          startWithPragma: vF, hasPragma: e => vF(CF(e).content.trimStart()), insertPragma: e => {
            const t = CF(e), n = '\x3c!-- @'.concat(bF[0], ' --\x3e');
            return t.frontMatter ? ''.concat(t.frontMatter.raw, '\n\n').concat(n, '\n\n').concat(t.content) : ''.concat(n, '\n\n').concat(t.content);
          }
        };
        const { getOrderedListItemInfo: FF, mapAst: xF, splitText: SF } = pF,
          wF = /^([\u0000-\uffff]|[\ud800-\udbff][\udc00-\udfff])$/;
        ...
        const {
            getLast: _F,
            getMinNotPresentContinuousCount: LF,
            getMaxContinuousCount: IF,
            getStringWidth: MF
          } = Lt, {
            builders: {
              breakParent: jF,
              ...
              indent: XF,
              group: YF
            }, utils: { normalizeDoc: KF }, printer: { printDocToString: QF }
          } = cn, { replaceEndOfLineWith: ZF } = Lt, { insertPragma: ex } = AF, {
            locStart: tx,
            locEnd: nx
          } = ZA, {
            getFencedCodeBlockValue: rx,
            hasGitDiffFriendlyOrderedList: ox,
            splitText: ux,
            punctuationPattern: ix,
            INLINE_NODE_TYPES: ax,
            INLINE_NODE_WRAPPER_TYPES: sx,
            isAutolink: cx
          } = pF, lx = new Set(['importExport']), px = ['heading', 'tableCell', 'link', 'wikiLink'],
          dx = new Set(['listItem', 'definition', 'footnoteDefinition']);

        function fx(e, t, n, r) {
          const o = e.getValue(), u = null === o.checked ? '' : o.checked ? '[x] ' : '[ ] ';
          return RF([u, Ex(e, t, n, {
            processor: (e, o) => {
              if (0 === o && 'list' !== e.getValue().type) return GF(' '.repeat(u.length), e.call(n));
              const i = ' '.repeat((3, (a = t.tabWidth - r.length) < 0 ? 0 : a > 3 ? 3 : a));
              var a;
              return RF([i, GF(i, e.call(n))]);
            }
          })]);
        }
        ...
        function Dx(e, t, n) {
          ...
          const r = 'always' === n.proseWrap && !gx(e, px);
          return '' !== t ? r ? VF : ' ' : r ? JF : '';
        }
        ...
        function yx(e, t, n) {
          ...
          return u.forEach(((e, t) => {
            ...
            processor: (e, o) => {
              if (0 !== r.length) {
                const e = r[0];
                if (o === e.start.index) return RF([u[e.start.index].value, t.originalText.slice(e.start.offset, e.end.offset), u[e.end.index].value]);
        ...
        function Ex(e, t, n, r) {
          const o = (r = r || {}).postprocessor || RF, u = r.processor || (e => e.call(n)), i = e.getValue(), a = [];
          let s;
          return e.each(((e, n) => {
            ...
            if (!1 !== o) {
              ...
              (function(e, t) {
                const n = 0 === t.parts.length, r = ax.includes(e.type),
                ...
                const n = (t.prevNode && t.prevNode.type) === e.type && dx.has(e.type),
                  ...
                  o = t.prevNode && 'listItem' === t.prevNode.type && t.prevNode.loose, u = 'next' === bx(t.prevNode),
        ...
        function Fx(e, t, n) {
          ...
          const r = e.split('\'').length - 1, o = e.split('"').length - 1,
        ...
        var xx = {
          preprocess: function(e, t) {
            return function(e) {
              return TF(e, ((e, t) => 'importExport' === e.type && 'importExport' === t.type), ((e, t) => ({
                type: 'importExport',
                value: e.value + '\n\n' + t.value,
                position: { start: e.position.start, end: t.position.end }
              })));
            }(e = function(e) {
              return xF(e, (e => 'import' !== e.type && 'export' !== e.type ? e : Object.assign({}, e, { type: 'importExport' })));
            }(e = function(e, t) {
              return xF(e, ((e, n, [r]) => {
              ...
              function r(e) {
                ...
                if (FF(r, t.originalText).leadingSpaces.length > 1) return !0;
                const u = n(r);
                return -1 !== u && (1 === e.children.length ? u % t.tabWidth == 0 : u === n(o) && (u % t.tabWidth == 0 || FF(o, t.originalText).leadingSpaces.length > 1));
              }
            }(e = function(e, t) {
              return xF(e, ((e, n, r) => {
                if ('code' === e.type) {
              ...
              return xF(e, (e => 'inlineCode' !== e.type ? e : Object.assign({}, e, { value: e.value.replace(/\s+/g, ' ') })));
            }(e = function(e) {
              return TF(e, ((e, t) => 'text' === e.type && 'text' === t.type), ((e, t) => ({
                type: 'text',
                value: e.value + t.value,
                position: { start: e.position.start, end: t.position.end }
              })));
            }(e = function(e, t) {
              return xF(e, (e => 'text' === e.type && '*' !== e.value && '_' !== e.value && wF.test(e.value) && e.position.end.offset - e.position.start.offset !== e.value.length ? Object.assign({}, e, { value: t.originalText.slice(e.position.start.offset, e.position.end.offset) }) : e));
            }(e, t))), t), t), t)));
          }, print: function(e, t, n) {
            const r = e.getValue();
            if (function(e) {
              const t = gx(e, ['linkReference', 'imageReference']);
              return t && ('linkReference' !== t.type || 'full' !== t.referenceType);
            }(e)) return RF(ux(t.originalText.slice(r.position.start.offset, r.position.end.offset), t).map((n => 'word' === n.type ? n.value : '' === n.value ? '' : Dx(e, n.value, t))));
            switch (r.type) {
              case'front-matter':
              ...
              case'word': {
                ...
                const n = (e, t, n) => 'sentence' === e.type && 0 === n, o = (e, t, n) => cx(e.children[n - 1]);
                return t !== r.value && (e.match(void 0, n, o) || e.match(void 0, n, ((e, t, n) => 'emphasis' === e.type && 0 === n), o)) && (t = t.replace(/^(\\?[*_])+/, (e => e.replace(/\\/g, '')))), t;
              }
              case'whitespace': {
                const n = e.getParentNode(), o = n.children.indexOf(r), u = n.children[o + 1],
                  i = u && /^>|^([*+-]|#{1,6}|\d+[).])$/.test(u.value) ? 'never' : t.proseWrap;
                return Dx(e, r.value, { proseWrap: i });
              }
              case'emphasis': {
                let o;
                if (cx(r.children[0])) o = t.originalText[r.position.start.offset]; else {
              ...
              case'delete':
                return RF(['~~', Ex(e, t, n), '~~']);
              case'inlineCode': {
                const e = LF(r.value, '`'), t = '`'.repeat(e || 1), n = e && !/^\s/.test(r.value) ? ' ' : '';
              ...
              case'code': {
                if (r.isIndented) {
                  const e = ' '.repeat(4);
                  return GF(e, RF([e, RF(ZF(r.value, UF))]));
                }
                const e = t.__inJsTemplate ? '~' : '`', n = e.repeat(Math.max(3, IF(r.value, e) + 1));
              ...
              case'list': {
                const o = hx(r, e.getParentNode()), u = ox(r, t);
                return Ex(e, t, n, {
                  processor: (e, i) => {
                    const a = function() {
              ...
              case'thematicBreak': {
                const t = mx(e, 'list');
                return -1 === t ? '---' : hx(e.getParentNode(t), e.getParentNode(t + 1)) % 2 == 0 ? '***' : '---';
              }
              case'linkReference':
              ...
              case'definition': {
                const e = 'always' === t.proseWrap ? VF : ' ';
                return YF(RF([RF(['[', r.identifier, ']:']), XF(RF([e, Ax(r.url), null === r.title ? '' : RF([e, Fx(r.title, t, !1)])]))]));
              }
              case'footnote':
                return RF(['[^', Ex(e, t, n), ']']);
              ...
              case'table':
                return function(e, t, n) {
                  const r = UF.parts[0], o = e.getValue(), u = [], i = e.map((e => e.map(((e, r) => {
                    const o = QF(e.call(n), t).formatted, i = MF(o);
                  ...
                  function c(e) {
                    const t = [p(i[0], e), l(e)];
                    return i.length > 1 && t.push(qF(r, i.slice(1).map((t => p(t, e))))), qF(r, t);
                  }

                  function l(e) {
                    const t = u.map(((t, n) => {
                      const r = o.align[n], u = 'center' === r || 'left' === r ? ':' : '-',
                        i = 'center' === r || 'right' === r ? ':' : '-', a = e ? '-' : '-'.repeat(t - 2);
            ...
            if ('code' === o.type && null !== o.lang) {
              const e = dF(o.lang, r);
              if (e) {
                const t = r.__inJsTemplate ? '~' : '`', u = t.repeat(Math.max(3, fF(o.value, t) + 1)),
            ...
            return null;
          }, massageAstNode: OF, hasPrettierIgnore: function(e) {
            const t = +e.getName();
            return 0 !== t && 'next' === bx(e.getParentNode().children[t - 1]);
          }, insertPragma: ex
        }, Sx = { proseWrap: AC.proseWrap, singleQuote: AC.singleQuote }, wx = {
          name: 'Markdown',
          type: 'prose',
          color: '#083fa1',
          aliases: ['pandoc'],
          ...
          languages: [vs(wx, (e => ({
            ...
            filenames: [],
            extensions: ['.mdx']
          })))], options: Sx, printers: { mdast: xx }, parsers: {
            get remark() {
        ...
        const { isFrontMatterNode: Bx } = Lt,
          kx = new Set(['sourceSpan', 'startSourceSpan', 'endSourceSpan', 'nameSpan', 'valueSpan']);

        function Nx(e, t) {
          return 'text' === e.type || 'comment' === e.type || Bx(e) || 'yaml' === e.type || 'toml' === e.type ? null : ('attribute' === e.type && delete t.value, void ('docType' === e.type && delete t.value));
        }

        Nx.ignoredProperties = kx;
        var Px = Nx;
        const { inferParserByLanguage: Ox, isFrontMatterNode: _x } = Lt, {
            CSS_DISPLAY_TAGS: Lx,
            CSS_DISPLAY_DEFAULT: Ix,
            CSS_WHITE_SPACE_TAGS: Mx,
            CSS_WHITE_SPACE_DEFAULT: jx
          } = {
            CSS_DISPLAY_TAGS: {
              area: 'none',
              base: 'none',
        ...
        function Jx(e, t) {
          return !('ieConditionalComment' !== e.type || !e.lastChild || e.lastChild.isSelfClosing || e.lastChild.endSourceSpan) || 'ieConditionalComment' === e.type && !e.complete || !(!rS(e) || !e.children.some((e => 'text' !== e.type && 'interpolation' !== e.type))) || !(!cS(e, t) || Hx(e) || 'interpolation' === e.type);
        }

        function zx(e) {
          return 'attribute' !== e.type && !!e.parent && 'number' == typeof e.index && 0 !== e.index && function(e) {
            return 'comment' === e.type && 'prettier-ignore' === e.value.trim();
          }(e.parent.children[e.index - 1]);
        }

        function Hx(e) {
          return 'element' === e.type && ('script' === e.fullName || 'style' === e.fullName || 'svg:style' === e.fullName || oS(e) && ('script' === e.name || 'style' === e.name));
        }

        function Gx(e) {
          return uS(e).startsWith('pre');
        }
        ...
        function Yx(e) {
          return eS(e) || 'element' === e.type && 'br' === e.fullName || Kx(e);
        }
        ...
        function uS(e) {
          return 'element' === e.type && (!e.namespace || oS(e)) && Mx[e.name] || jx;
        }

        const iS = new Set(['template', 'style', 'script']);

        function aS(e, t) {
          return sS(e, t) && !iS.has(e.fullName);
        }
        ...
        function cS(e, t) {
          return sS(e, t) && (aS(e, t) || e.attrMap.lang && 'html' !== e.attrMap.lang);
        }
        ...
        var lS = {
          ...
          forceBreakContent: function(e) {
            return Xx(e) || 'element' === e.type && 0 !== e.children.length && (['body', 'script', 'style'].includes(e.name) || e.children.some((e => function(e) {
              return e.children && e.children.some((e => 'text' !== e.type));
            }(e)))) || e.firstChild && e.firstChild === e.lastChild && 'text' !== e.firstChild.type && Qx(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || Zx(e.lastChild));
          },
          forceNextEmptyLine: function(e) {
            return _x(e) || e.next && e.sourceSpan.end && e.sourceSpan.end.line + 1 < e.next.sourceSpan.start.line;
          },
          ...
          inferScriptParser: function(e, t) {
            ...
            }(e) : t && cS(e, t) ? tS(e) || !('src' in e.attrMap) && Ox(e.attrMap.lang, t) : void 0 : e.attrMap.lang || e.attrMap.type ? tS(e) : 'babel';
          },
          isVueCustomBlock: aS,
          ...
          isDanglingSpaceSensitiveNode: function(e) {
            return !(nS(t = e.cssDisplay) || 'inline-block' === t || Hx(e));
            var t;
          },
          isIndentationSensitiveNode: Gx,
          isLeadingSpaceSensitiveNode: function(e, t) {
            const n = function() {
              return !(_x(e) || ('text' !== e.type && 'interpolation' !== e.type || !e.prev || 'text' !== e.prev.type && 'interpolation' !== e.prev.type) && (!e.parent || 'none' === e.parent.cssDisplay || !rS(e.parent) && (!e.prev && ('root' === e.parent.type || rS(e) && e.parent || Hx(e.parent) || aS(e.parent, t) || (n = e.parent.cssDisplay, nS(n) || 'inline-block' === n)) || e.prev && !function(e) {
                return !nS(e);
              }(e.prev.cssDisplay))));
              var n;
            }();
          ...
          isTrailingSpaceSensitiveNode: function(e, t) {
            return !(_x(e) || ('text' !== e.type && 'interpolation' !== e.type || !e.next || 'text' !== e.next.type && 'interpolation' !== e.next.type) && (!e.parent || 'none' === e.parent.cssDisplay || !rS(e.parent) && (!e.next && ('root' === e.parent.type || rS(e) && e.parent || Hx(e.parent) || aS(e.parent, t) || (n = e.parent.cssDisplay, nS(n) || 'inline-block' === n)) || e.next && !function(e) {
              return !nS(e);
            }(e.next.cssDisplay))));
            var n;
          },
          isWhitespaceSensitiveNode: function(e) {
            return Hx(e) || 'interpolation' === e.type || Gx(e);
          },
          isUnknownNamespace: oS,
          preferHardlineAsLeadingSpaces: function(e) {
            return eS(e) || e.prev && Yx(e.prev) || Kx(e);
          },
          preferHardlineAsTrailingSpaces: Yx,
          shouldNotPrintClosingTag: function(e, t) {
            return !e.isSelfClosing && !e.endSourceSpan && (zx(e) || Jx(e.parent, t));
          },
          ...
          t.dashCaseToCamelCase = function(e) {
            ...
            assertSync: e => {
              ...
              return e;
            }, then: (e, t) => s(e) ? e.then(t) : t(e), all: e => e.some(s) ? Promise.all(e) : e
          }, t.error = function(e) {
          ...
          function u(e) {
            ...
            const t = e.reference;
            if (t instanceof dS.StaticSymbol) return t.name;
            if (t.__anonymousType) return t.__anonymousType;
            let n = fS.stringify(t);
          ...
          t.identifierName = u, t.identifierModuleUrl = function(e) {
            const t = e.reference;
            return t instanceof dS.StaticSymbol ? t.filePath : './'.concat(fS.stringify(t));
          ...
          t.CompileDirectiveMetadata = a, t.CompilePipeMetadata = class {
            ...
            let r;
            return r = n.isInline ? t.type.reference instanceof dS.StaticSymbol ? ''.concat(t.type.reference.filePath, '.').concat(t.type.reference.name, '.html') : ''.concat(u(e), '/').concat(u(t.type), '.html') : n.templateUrl, t.type.reference instanceof dS.StaticSymbol ? r : l(r);
          ...
          class n {
            ...
            moveBy(e) {
              ...
              for (; o > 0 && e < 0;) if (o--, e++, t.charCodeAt(o) == pS.$LF) {
                u--;
          ...
          }(u = t.ParseErrorLevel || (t.ParseErrorLevel = {})), t.ParseError = class {
        ...
        const { ParseSourceSpan: gS } = mS, {
          htmlTrim: DS,
          getLeadingAndTrailingHtmlWhitespace: yS,
          hasHtmlWhitespace: ES,
          canHaveInterpolation: CS,
          getNodeCssStyleDisplay: bS,
          isDanglingSpaceSensitiveNode: vS,
          isIndentationSensitiveNode: AS,
          isLeadingSpaceSensitiveNode: FS,
          isTrailingSpaceSensitiveNode: xS,
          isWhitespaceSensitiveNode: SS
        } = lS, wS = [function(e) {
          return e.map((e => {
            ...
            if (e.children) {
              ...
              if (n.some(Boolean)) {
                ...
                for (let r = 0; r < e.children.length; r++) {
                  ...
                  if (!n[r + 1]) if (n[r]) {
                    const e = o.prev, n = o.firstChild, r = new gS(e.sourceSpan.start, n.sourceSpan.end),
                ...
                if (r.some(Boolean)) {
                  ...
                  for (let o = 0; o < e.children.length; o++) {
                    ...
                    t.push(a.clone({
                      ...
                      sourceSpan: new gS(a.sourceSpan.start, i.sourceSpan.end)
                    }));
                  }
                  return e.clone({ children: t });
                }
            ...
            for (const r of e.children) {
              ...
              for (let n = 0; n < u.length; n++, e = o) {
                ...
                n % 2 != 0 ? (o = e.moveBy(r.length + 4), t.push({
                  type: 'interpolation',
                  sourceSpan: new gS(e, o),
                  children: 0 === r.length ? [] : [{
                    type: 'text',
                    value: r,
                    sourceSpan: new gS(e.moveBy(2), o.moveBy(-2))
                  }]
          ...
          return e.map((e => {
            if (!e.children) return e;
            if (0 === e.children.length || 1 === e.children.length && 'text' === e.children[0].type && 0 === DS(e.children[0].value).length) return e.clone({
              children: [],
            ...
            return e.clone({
              ...
              children: e.children.reduce(((e, r) => {
                ...
                const o = [], { leadingWhitespace: u, text: i, trailingWhitespace: a } = yS(r.value);
                return u && o.push({ type: t }), i && o.push({
                  type: 'text',
                  value: i,
                  sourceSpan: new gS(r.sourceSpan.start.moveBy(u.length), r.sourceSpan.end.moveBy(-a.length))
                }), a && o.push({ type: t }), e.concat(o);
              }), []).reduce(((e, n, r, o) => {
          ...
          return e.map((e => Object.assign(e, { cssDisplay: bS(e, t) })));
        }, function(e) {
          ...
          return e.map((e => e.children ? 0 === e.children.length ? e.clone({ isDanglingSpaceSensitive: vS(e) }) : e.clone({
            children: e.children.map((e => Object.assign({}, e, {
              isLeadingSpaceSensitive: FS(e, t),
              isTrailingSpaceSensitive: xS(e, t)
                ...
                for (let r = 0; r < e.children.length; r++) {
                  ...
                  if (n[r]) {
                    ...
                    t.push(n.clone({
                      ...
                      sourceSpan: new gS(n.sourceSpan.start, u.sourceSpan.end),
        ...
        var kS = {
          isVueEventBindingExpression: function(e) {
            ...
            const { left: n, operator: r, right: o } = function(e) {
              const t = /,([^,\]}]*)(?:,([^,\]}]*))?$/, n = e.match(/([^]*?)\s+(in|of)\s+([^]*)/);
              if (!n) return;
              const r = {};
              r.for = n[3].trim();
              const o = n[1].trim().replace(/^\(|\)$/g, ''), u = o.match(t);
              return u ? (r.alias = o.replace(t, ''), r.iterator1 = u[1].trim(), u[2] && (r.iterator2 = u[2].trim())) : r.alias = o, {
                left: ''.concat([r.alias, r.iterator1, r.iterator2].filter(Boolean).join(',')),
                operator: n[2],
                right: r.for
              };
            }(e);
            return TS([BS(t('function _('.concat(n, ') {}'), {
              parser: 'babel',
              __isVueForBindingLeft: !0
            })), ' ', r, ' ', t(o, { parser: '__js_expression' }, { stripTrailingHardline: !0 })]);
        ...
        var IS = {
          printImgSrcset: function(e) {
            ...
            const o = n ? 'w' : r ? 'h' : 'd', u = n ? 'w' : r ? 'h' : 'x', i = e => Math.max(...e),
              a = t.map((e => e.url)), s = i(a.map((e => e.length))),
              c = t.map((e => e[o])).map((e => e ? e.toString() : '')), l = c.map((e => {
                const t = e.indexOf('.');
        ...
        const {
          builders: MS,
          utils: { mapDoc: jS, normalizeParts: RS }
        } = cn, { replaceEndOfLineWith: qS } = Lt, { print: VS } = MC, {
          breakParent: $S,
          dedentToRoot: WS,
          fill: US,
          group: JS,
          ...
          htmlTrimPreserveIndentation: ZS,
          splitByHtmlWhitespace: ew,
          countChars: tw,
          countParents: nw,
          dedentString: rw,
          forceBreakChildren: ow,
          forceBreakContent: uw,
          forceNextEmptyLine: iw,
          getLastDescendant: aw,
          getPrettierIgnoreAttributeCommentData: sw,
          hasPrettierIgnore: cw,
          inferScriptParser: lw,
          isVueCustomBlock: pw,
          isVueNonHtmlBlock: dw,
          isVueSlotAttribute: fw,
          isVueSfcBindingsAttribute: hw,
          isScriptLikeTag: mw,
          isTextLikeNode: gw,
          preferHardlineAsLeadingSpaces: Dw,
          shouldNotPrintClosingTag: yw,
          shouldPreserveContent: Ew,
          unescapeQuoteEntities: Cw,
          isPreLikeNode: bw
        } = lS, { insertPragma: vw } = {
          hasPragma: function(e) {
        ...
        }, { locStart: Aw, locEnd: Fw } = {
          locStart: function(e) {
            return e.sourceSpan.start.offset;
          }, locEnd: function(e) {
            return e.sourceSpan.end.offset;
          }
        }, { printVueFor: xw, printVueBindings: Sw, isVueEventBindingExpression: ww } = kS, {
          printImgSrcset: Tw,
          printClassNames: Bw
        } = IS;
        ...
        function kw(e) {
          const t = RS(e);
          return 0 === t.length ? '' : 1 === t.length ? t[0] : MS.concat(t);
        }
        ...
        function Nw(e, t, n) {
          ...
          return kw(e.map(((e, t) => {
            ...
            if (gw(n)) {
              if (n.prev && gw(n.prev)) {
                const t = i(n.prev, n);
                if (t) return iw(n.prev) ? kw([zS, zS, u(e)]) : kw([t, u(e)]);
              }
              return u(e);
            }
          ...
          function u(e) {
            const r = e.getValue();
            return cw(r) ? kw([].concat(Jw(r, t), qS(t.originalText.slice(Aw(r) + (r.prev && qw(r.prev) ? Gw(r).length : 0), Fw(r) - (r.next && $w(r.next) ? Kw(r, t).length : 0)), KS), Hw(r, t))) : n(e);
          }

          function i(e, t) {
            return gw(e) && gw(t) ? e.isTrailingSpaceSensitive ? e.hasTrailingSpaces ? Dw(t) ? zS : YS : '' : Dw(t) ? zS : QS : qw(e) && (cw(t) || t.firstChild || t.isSelfClosing || 'element' === t.type && 0 !== t.attrs.length) || 'element' === e.type && e.isSelfClosing && $w(t) ? '' : !t.isLeadingSpaceSensitive || Dw(t) || $w(t) && e.lastChild && Uw(e.lastChild) && e.lastChild.lastChild && Uw(e.lastChild.lastChild) ? zS : t.hasLeadingSpaces ? YS : QS;
          }
        }
        ...
        function Ow(e, t, n) {
          ...
          const o = r.prev && 'comment' === r.prev.type && sw(r.prev.value),
            ...
            i = e.map((e => {
              const r = e.getValue();
              return u(r) ? kw(qS(t.originalText.slice(Aw(r), Fw(r)), KS)) : n(e);
            }), 'attrs'),
        ...
        function _w(e, t, n) {
          const r = e.getValue();
          return kw([Lw(r, t), Ow(e, t, n), r.isSelfClosing ? '' : Iw(r)]);
        }

        function Lw(e, t) {
          return e.prev && qw(e.prev) ? '' : kw([Jw(e, t), Gw(e)]);
        }

        function Iw(e) {
          return e.firstChild && Vw(e.firstChild) ? '' : Xw(e);
        }

        function Mw(e, t) {
          return kw([e.isSelfClosing ? '' : jw(e, t), Rw(e, t)]);
        }

        function jw(e, t) {
          return e.lastChild && Uw(e.lastChild) ? '' : kw([zw(e, t), Yw(e, t)]);
        }

        function Rw(e, t) {
          return (e.next ? $w(e.next) : Ww(e.parent)) ? '' : kw([Kw(e, t), Hw(e, t)]);
        }

        function qw(e) {
          return e.next && !gw(e.next) && gw(e) && e.isTrailingSpaceSensitive && !e.hasTrailingSpaces;
        }
        ...
        function $w(e) {
          return e.prev && 'docType' !== e.prev.type && !gw(e.prev) && e.isLeadingSpaceSensitive && !e.hasLeadingSpaces;
        }

        function Ww(e) {
          return e.lastChild && e.lastChild.isTrailingSpaceSensitive && !e.lastChild.hasTrailingSpaces && !gw(aw(e.lastChild)) && !bw(e);
        }

        function Uw(e) {
          return !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && gw(aw(e));
        }

        function Jw(e, t) {
          return Vw(e) ? Xw(e.parent) : $w(e) ? Kw(e.prev, t) : '';
        }

        function zw(e, t) {
          return Ww(e) ? Kw(e.lastChild, t) : '';
        }

        function Hw(e, t) {
          return Uw(e) ? Yw(e.parent, t) : qw(e) ? Gw(e.next) : '';
        }
        ...
        function Qw(e, t = e.value) {
          return e.parent.isWhitespaceSensitive ? e.parent.isIndentationSensitive ? qS(t, KS) : qS(rw(ZS(t)), zS) : XS(YS, ew(t)).parts;
        }

        var Zw = {
          preprocess: function(e, t) {
            for (const n of wS) e = n(e, t);
            return e;
          }, print: function(e, t, n) {
            const r = e.getValue();
            switch (r.type) {
              ...
              case'attribute': {
                ...
                const e = Cw(r.value), t = tw(e, '\'') < tw(e, '"') ? '\'' : '"';
            ...
            var o;
          }, insertPragma: vw, massageAstNode: Px, embed: function(e, t, n, r) {
            const o = e.getValue();
            switch (o.type) {
              case'element':
              ...
              case'text':
                ...
                } else if ('interpolation' === o.parent.type) return kw([GS(kw([YS, n(o.value, Object.assign({ __isInHtmlInterpolation: !0 }, 'angular' === r.parser ? {
                  parser: '__ng_interpolation',
                  trailingComma: 'none'
                } : 'vue' === r.parser ? { parser: '__vue_expression' } : { parser: '__js_expression' }), { stripTrailingHardline: !0 })])), o.parent.next && $w(o.parent.next) ? ' ' : YS]);
                break;
              case'attribute': {
                if (!o.value) break;
                ...
                const e = function(e, t, n) {
                  const r = t => new RegExp(t.join('|')).test(e.fullName), o = () => Cw(e.value);
                  let u = !1;
                  const i = (e, t) => {
                    ...
                    }, a = (e, t = !0) => JS(kw([GS(kw([QS, e])), t ? QS : ''])), s = e => u ? (e => JS(e))(e) : a(e),
                  ...
                  if ('vue' === n.parser) {
                    ...
                    if (r(['^@', '^v-on:'])) {
                      const e = o();
                      return s(c(e, { parser: ww(e) ? '__js_expression' : '__vue_event_binding' }));
                    }
                    if (r(t)) return s(c(o(), { parser: '__vue_expression' }));
                    if (r(u)) return s(c(o(), { parser: '__js_expression' }));
                  }
                  if ('angular' === n.parser) {
                    const t = (e, t) => c(e, Object.assign({}, t, { trailingComma: 'none' })), n = ['^\\*'],
                      u = ['^\\[.+\\]$', '^bind(on)?-', '^ng-(if|show|hide|class|style)$'], i = ['^i18n(-.+)?$'];
                    if (r(['^\\(.+\\)$', '^on-'])) return s(t(o(), { parser: '__ng_action' }));
                    if (r(u)) return s(t(o(), { parser: '__ng_binding' }));
                    if (r(i)) {
                      const t = o().trim();
                      return a(US(Qw(e, t)), !t.includes('@@'));
                    }
                    ...
                    if (l.test(p)) {
                      ...
                      return p.split(l).forEach(((n, r) => {
                        if (r % 2 == 0) e.push(kw(qS(n, KS))); else try {
                          e.push(JS(kw(['{{', GS(kw([YS, t(n, {
                            parser: '__ng_interpolation',
        ...
        var tT = {
          ...
          languages: [vs(nT, (() => ({
            ...
            aceMode: 'html',
            languageId: 391
          }, (() => ({ since: '1.10.0', parsers: ['vue'], vscodeLanguageIds: ['vue'] })))],
          printers: { html: Zw },
          options: tT,
          parsers: {
            get html() {
        ...
        var fT = {
          ...
          isEmptyNode: function(e) {
            return !(e.children && 0 !== e.children.length || function(e) {
              return aT(e) || sT(e) || cT(e) || lT(e) || pT(e);
            }(e));
          },
          ...
          getBlockValueLineContents: function(e, { parentIndent: t, isLastDescendant: n, options: r }) {
            ...
            function s(t) {
              if ('keep' === e.chomping) return 0 === oT(t).length ? t.slice(0, -1) : t;
              let r = 0;
          ...
          getFlowScalarLineContents: function(e, t, n) {
            ...
            return 'preserve' === n.proseWrap ? r.map((e => 0 === e.length ? [] : [e])) : r.map((e => 0 === e.length ? [] : dT(e))).reduce(((t, n, o) => 0 === o || 0 === r[o - 1].length || 0 === n.length || 'quoteDouble' === e && oT(oT(t)).endsWith('\\') ? t.concat([n]) : t.concat([t.pop().concat(n)])), []).map((e => 'never' === n.proseWrap ? [e.join(' ')] : e));
          },
          getLastDescendantNode: function e(t) {
            return 'children' in t && 0 !== t.children.length ? e(oT(t.children)) : t;
          },
          hasPrettierIgnore: function(e) {
            const t = e.getValue();
            if ('documentBody' === t.type) {
              const t = e.getParentNode();
              return pT(t.head) && iT(oT(t.head.endComments));
            }
            return aT(t) && iT(oT(t.leadingComments));
          },
        ...
        const hT = cn.builders, {
          ...
          markAsRoot: TT,
          softline: BT
        } = hT, { replaceEndOfLineWith: kT, isPreviousLineEmpty: NT } = Lt, {
          insertPragma: PT,
          isPragma: OT
        } = {
          isPragma: function(e) {
          ...
          getAncestorCount: LT,
          getBlockValueLineContents: IT,
          getFlowScalarLineContents: MT,
          getLast: jT,
          getLastDescendantNode: RT,
          hasLeadingComments: qT,
          hasMiddleComments: VT,
          hasIndicatorComment: $T,
          hasTrailingComment: WT,
          hasEndComments: UT,
          hasPrettierIgnore: JT,
          isLastDescendantNode: zT,
          isNextLineEmpty: HT,
          isNode: GT,
          isEmptyNode: XT,
          defineShortcut: YT,
        ...
        function ZT(e, t, n, r, o) {
          switch (e.type) {
            ...
            case'document': {
              ...
              return FT(vT, ['head' === oB(e, u, t, r) ? FT(vT, [0 === e.head.children.length && 0 === e.head.endComments.length ? '' : n.call(o, 'head'), DT(['---', WT(e.head) ? DT([' ', n.call(o, 'head', 'trailingComment')]) : ''])].filter(Boolean)) : '', nB(e) ? n.call(o, 'body') : ''].filter(Boolean));
            }
            case'documentHead':
              return FT(vT, [].concat(n.map(o, 'children'), n.map(o, 'endComments')));
            case'documentBody': {
              const t = FT(vT, n.map(o, 'children')).parts, r = FT(vT, n.map(o, 'endComments')).parts,
            ...
            case'blockFolded':
            case'blockLiteral': {
              const t = LT(n, (e => GT(e, ['sequence', 'mapping']))), u = zT(n);
              return DT(['blockFolded' === e.type ? '>' : '|', null === e.indent ? '' : e.indent.toString(), 'clip' === e.chomping ? '' : 'keep' === e.chomping ? '+' : '-', $T(e) ? DT([' ', n.call(o, 'indicatorComment')]) : '', (null === e.indent ? yT : ET)(eB(null === e.indent ? r.tabWidth : e.indent - 1 + t, DT(IT(e, {
                parentIndent: t,
                isLastDescendant: u,
                options: r
              }).reduce(((t, n, r, o) => t.concat(0 === r ? vT : '', CT(FT(xT, n).parts), r !== o.length - 1 ? 0 === n.length ? vT : TT(wT) : 'keep' === e.chomping && u ? 0 === n.length ? ET(vT) : ET(wT) : '')), []))))]);
            }
            case'sequence':
            ...
            case'flowMapping':
            case'flowSequence': {
              const t = 'flowMapping' === e.type ? '{' : '[', i = 'flowMapping' === e.type ? '}' : ']',
          ...
          function a(e) {
            return hT.align(' '.repeat(r.tabWidth), e);
          }
        }

        function eB(e, t) {
          return 'number' == typeof e && e > 0 ? hT.align(' '.repeat(e), t) : hT.align(e, t);
        }
        ...
        function nB(e) {
          return 0 !== e.body.children.length || UT(e.body);
        }

        function rB(e, t) {
          return WT(e) || t && (0 !== t.head.children.length || UT(t.head));
        }

        function oB(e, t, n, r) {
          return n.children[0] === e && /---(\s|$)/.test(r.originalText.slice(_T(e), _T(e) + 4)) || 0 !== e.head.children.length || UT(e.head) || WT(e.head) ? 'head' : !rB(e, t) && !!t && 'root';
        }
        ...
        function aB(e) {
          return UT(e) && !GT(e, ['documentHead', 'documentBody', 'flowMapping', 'flowSequence']);
        }
        ...
        function lB(e, t, n) {
          const r = MT(e, t, n);
          return FT(vT, r.map((e => CT(FT(xT, e).parts))));
        }
        ...
        var pB = {
            preprocess: function(e) {
              ...
              const r = e.getValue(), o = e.getParentNode(), u = r.tag ? e.call(n, 'tag') : '',
          ...
          fB = [TC, Tv, OA, QA, Tx, rT, {
            ...
            })))], printers: { yaml: pB }, options: dB, parsers: {
              get yaml() {
                return {}.parsers.yaml;
              }
            }
        ...
        return {
          formatWithCursor: yB,
          format: (e, t) => yB(e, t).formatted,
          check(e, t) {
            const { formatted: n } = yB(e, t);
            return n === e;
          },
          doc: cn,
          getSupportInfo: DB(mB, 0),
          version: hB,
          util: bs,
          __debug: {
            parse: DB(Ka.parse),
            formatAST: DB(Ka.formatAST),
            formatDoc: DB(Ka.formatDoc),
            printToDoc: DB(Ka.printToDoc),
            printDocToString: DB(Ka.printDocToString)
          }
        };
      }();
    }
  ...
  n.g = function() {
    ...
    'use strict';
    const e = function() {
      const t = document.querySelector('canvas'), n = t.getContext('2d'),
      ...
      function a() {
        this.x = Math.random() * t.width, this.y = Math.random() * t.height, this.vx = -.5 + Math.random(), this.vy = -.5 + Math.random(), this.radius = 1.5 * Math.random(), this.colour = r[Math.floor(Math.random() * r.length)];
      }

      i = u > 1600 ? { nb: 600, distance: 70, d_radius: 300, array: [] } : u > 1300 ? {
        nb: 575,
        distance: 60,
        d_radius: 280,
        array: []
      } : u > 1100 ? { nb: 500, distance: 55, d_radius: 250, array: [] } : u > 800 ? {
        nb: 300,
        distance: 0,
        d_radius: 0,
        array: []
        ...
        create: function() {
          ...
          for (let e = 0; e < i.nb; e++) for (let t = 0; t < i.nb; t++) {
        ...
        try {
          i.array[0].x = e.pageX, i.array[0].y = e.pageY;
        } catch {
        }
      ...
      const e = document.querySelector('.canvas-2'), t = e.getContext('2d'),
      ...
      function a() {
        this.x = Math.random() * e.width, this.y = Math.random() * e.height, this.vx = -.5 + Math.random(), this.vy = -.5 + Math.random(), this.radius = 1.5 * Math.random(), this.colour = n[Math.floor(Math.random() * n.length)];
      }

      u > 1600 ? i = { nb: 100, distance: 0, d_radius: 0, array: [] } : u > 1300 ? i = {
        nb: 75,
        distance: 0,
        d_radius: 0,
        array: []
      } : u > 1100 ? i = { nb: 50, distance: 0, d_radius: 0, array: [] } : (i = {
        nb: 1,
        distance: 0,
        d_radius: 0,
        array: []
      }, t.globalAlpha = 0), a.prototype = {
        create: function() {
          ...
          for (let e = 0; e < i.nb; e++) for (let n = 0; n < i.nb; n++) {
            const r = i.array[e], u = i.array[n];
            if (r.x - u.x < i.distance && r.y - u.y < i.distance && r.x - u.x > -i.distance && r.y - u.y > -i.distance && r.x - o.x < i.d_radius && r.y - o.y < i.d_radius && r.x - o.x > -i.d_radius && r.y - o.y > -i.d_radius) {
    ...
    let a = new IntersectionObserver((function(e, t) {
      e.forEach((e => {
        e.isIntersecting && (i.forEach((e => {
          e.classList.remove('navigation__item--active');
        })), document.querySelector(`#nav-${e.target.id}`).classList.add('navigation__item--active'));
      }));
    }), u);
    a.observe(document.querySelector('#hero')), a.observe(document.querySelector('#about')), a.observe(document.querySelector('#contact')), new IntersectionObserver((function(e, t) {
      e.forEach((e => {
        e.isIntersecting && (i.forEach((e => {
          e.classList.remove('navigation__item--active');
        })), document.querySelector(`#nav-${e.target.id}`).classList.add('navigation__item--active'));
      }));
    }), { root: null, rootMargin: '0px', threshold: .2 }).observe(document.querySelector('#projects'));
    const s = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
    document.querySelector('#form-submit').addEventListener('click', (() => {
      const e = document.querySelector('.contact__form-name'), t = document.querySelector('.contact__form-email'),
        n = document.querySelector('.contact__form-message'), r = e.value, o = t.value, u = n.value,
        i = document.querySelector('.form-error__name'), a = document.querySelector('.form-error__email'),
        c = document.querySelector('.form-error__msg');
      let l = !1, p = !1, d = !1;
      r ? (l = !0, e.classList.remove('input-error'), i.style.display = 'none') : (l = !1, e.classList.add('input-error'), i.style.display = 'block'), o.match(s) ? (p = !0, t.classList.remove('input-error'), a.style.display = 'none') : (p = !1, t.classList.add('input-error'), a.style.display = 'block'), u ? (d = !0, n.classList.remove('input-error'), c.style.display = 'none') : (d = !1, n.classList.add('input-error'), c.style.display = 'block'), l && p && d && (document.querySelector('.contact__form').submit(), new Promise((e => setTimeout(e, 1500))).then((() => {
